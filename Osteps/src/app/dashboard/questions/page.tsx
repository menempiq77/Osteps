  ...
  return (
    <div className="premium-page rounded-2xl p-3 md:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Student View */}
        {isStudent && (
          <Card title="Ask Your Question" className="premium-card shadow-md">
            <Form layout="vertical">
              ...
              <Form.Item label="Your Question">
                ...
                <Button
                  ...
                  className="premium-pill-btn !bg-primary hover:bg-green-600 !text-white"
                >
                  Submit Question
                </Button>
            </Form>
        ...
        {(isTeacher || isHOD) && (
          <Card title="Filter Questions" className="premium-card shadow-md">
            <Form layout="vertical">
        ...
        {(isTeacher || isHOD) && activeQuestion && (
          <Card title="Answer This Question" className="premium-card shadow-md">
            <Form layout="vertical">
      ...
      <List
        ...
        renderItem={(question) => (
          <Card
            key={question.id}
            className={`premium-card mb-4 cursor-pointer transition-all ${
