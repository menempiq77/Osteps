...
use App\Http\Controllers\Api\SeatingLayoutController;
...
Route::middleware(['auth:sanctum'])->group(function(){
    ...
    Route::post('update-school-information',[ProfileController::class,'UpdateSchoolInformation'])->name('update-school-information');
    ...
    Route::post('duplicate-assessment/{id}',[AssessmentController::class,'duplicateAssessment'])->name('duplicate-assessment');
    ...
    Route::post('classes/{classId}/students/{studentId}/avatar',[StudentController::class,'updateStudentAvatar'])->name('update-student-avatar');
    ...
    Route::post('add-student-topic-marks',[TopicController::class,'addStudentTopicMarks'])->name('add-student-topic-marks'); //add each topic mark for student
    ...
    Route::get('manage-tracker-assignments',[AssignTrackerClassController::class,'manageAssignments'])->name('manage-tracker-assignments');
    ...
    Route::post('reorder-quiz-questions/{quizId}',[QuizQuestionController::class,'reorder'])->name('reorder-quiz-questions'); 
    ...
    Route::post('update-timeTable/{id}',[TimeTableController::class,'updateTimeTable'])->name('update-timeTable');
...
Route::get('leaderboard/school-self', [LeaderBoardController::class, 'schoolSelf'])->name('leaderboard-school-self');
    ...
    Route::post('subject-classes/sync-students-subjects', [SubjectClassController::class, 'syncStudentsSubjects'])->name('subject-classes-sync-students-subjects');
