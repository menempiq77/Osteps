  ...
  sections: [
    {
      ...
      callout: {
        ...
        body: {
          en: "NEWS REPORT — A large factory near a coastal town has been dumping toxic chemicals into the sea for over ten years, killing marine life and polluting the drinking water of 50,000 residents. When journalists confronted the factory owner, he replied: 'Nature fixes itself — I don't need old religious books to tell me how to treat the environment. My business creates jobs and that's what matters. Besides, who really knows if there is a God watching us? And even if there is, nobody will be held accountable after death — once you die, it's over. I only answer to the law, and the law didn't catch me for ten years.'\n\nRead the scenario carefully, then criticise the factory owner's attitude. In your response:\n1. Identify at least two things wrong with his reasoning.\n2. Provide evidence from the Qur'an (especially Surat As-Sajdah 1-12) to challenge his claims.\n3. Provide evidence from at least one other source: the Sunnah, science, or Islamic history.\n4. Suggest what the correct Islamic attitude towards the environment and accountability should be.",
          ar: "خَبَرٌ صَحَفِيّ — مَصنَعٌ كَبيرٌ قُربَ بَلدةٍ ساحِليّةٍ يَرمي مُخَلَّفاتٍ كيميائيّةً سامّةً في البَحرِ مُنذُ أكثَرَ مِن عَشرِ سَنَوات، ما أدّى إلى نُفوقِ الكائِناتِ البَحريّةِ وتَلويثِ مِياهِ الشُّربِ لِخَمسينَ ألفَ شَخص. حينَ واجَهَ الصَّحَفِيّونَ صاحِبَ المَصنَعِ أجاب: «الطَّبيعةُ تُصلِحُ نَفسَها — لا أحتاجُ كُتُبًا دينيّةً قَديمةً لِتُعَلِّمَني كَيفَ أتَعامَلُ مَعَ البيئة. مَصنَعي يُوَفِّرُ وَظائِفَ وهذا هو المُهِمّ. ثُمَّ مَن يَعلَمُ حَقًّا إن كانَ هُناكَ إلهٌ يُراقِبُنا؟ وحَتّى لَو وُجِد، لن يُحاسَبَ أحَدٌ بَعدَ المَوتِ — حينَ تَموتُ يَنتَهي كُلُّ شَيء. أنا لا أُجيبُ إلّا أمامَ القانون، والقانونُ لَم يَضبِطني عَشرَ سَنَوات.»\n\nاقرَأِ السِّيناريو بِعِنايةٍ ثُمَّ انتَقِدْ مَوقِفَ صاحِبِ المَصنَع. في إجابَتِك:\n١. حَدِّدْ خَطَأَينِ على الأقَلِّ في مَنطِقِه.\n٢. قَدِّمْ دَليلًا مِنَ القُرآنِ (خاصّةً سورة السجدة ١-١٢) لِلرَّدِّ على ادِّعاءاتِه.\n٣. قَدِّمْ دَليلًا مِن مَصدَرٍ آخَرَ على الأقَلّ: السُّنّة، أوِ العِلم، أوِ التّاريخِ الإسلامِيّ.\n٤. اقتَرِحْ ما يَنبَغي أن يَكونَ عَلَيهِ المَوقِفُ الإسلامِيُّ الصَّحيحُ تُجاهَ البيئةِ والمُحاسَبة.",
        },
      },
      responsePrompt: {
        title: { en: "Write your critical response", ar: "اكتُبْ رَدَّكَ النّاقِد" },
        prompt: {
          en: "Criticise the factory owner's claims using evidence from the Qur'an (especially As-Sajdah 1-12), the Sunnah, science, or Islamic history. Explain why his attitude is dangerous and what the correct Islamic position should be.",
          ar: "انتَقِدْ ادِّعاءاتِ صاحِبِ المَصنَعِ مُستَعينًا بِأدِلّةٍ مِنَ القُرآنِ (خاصّةً السجدة ١-١٢) والسُّنّةِ والعِلمِ أوِ التّاريخِ الإسلامِيّ. وَضِّحْ لِماذا مَوقِفُهُ خَطيرٌ وما المَوقِفُ الإسلامِيُّ الصَّحيح.",
        },
        placeholder: { en: "The factory owner is wrong because... The Qur'an says in As-Sajdah...", ar: "صاحِبُ المَصنَعِ مُخطِئٌ لِأنَّ... يَقولُ القُرآنُ في السجدة..." },
        buttonLabel: { en: "Save response", ar: "احفَظِ الإجابة" },
      },
      body: {
        en: "Before we begin studying Surat As-Sajdah 1-12, read the news scenario above and think critically about it. The factory owner makes several dangerous claims: that there is no Creator watching us, that no one will be held accountable after death, and that religious guidance is outdated. These are exactly the claims that Surat As-Sajdah powerfully addresses.\n\nAs you write your critical response, think about the following connections to our lesson:\n\u2022 As-Sajdah 2-3 declares the Qur'an is 'the truth from your Lord' — not an outdated book, but timeless divine guidance.\n\u2022 As-Sajdah 4 reminds us that Allah created the heavens and the earth — He owns creation, and destroying it is an act of ingratitude.\n\u2022 As-Sajdah 7 states that Allah 'perfected everything He created' — the seas, the marine life, and the ecosystems are His perfect design, not ours to ruin.\n\u2022 As-Sajdah 9 tells us Allah gave us hearing, sight, and hearts, then says 'little are you grateful' — the factory owner is the picture of ingratitude.\n\u2022 As-Sajdah 10-11 confirms that the Angel of Death will take every soul, 'then to your Lord you will be returned' — there IS accountability after death.\n\u2022 As-Sajdah 12 shows those who denied the truth begging to return, saying 'we have seen and heard' — but too late.\n\nThe Prophet \uFDFA said: 'The world is green and beautiful, and Allah has made you stewards over it' (Muslim). And science confirms that dumping toxic chemicals causes irreversible damage to marine ecosystems and human health. The factory owner's claim that 'nature fixes itself' is both scientifically false and morally bankrupt.\n\nUse the writing space below to build your full critical response with evidence.",
        ar: "قَبلَ أن نَبدَأَ دِراسةَ سورةِ السَّجدةِ ١-١٢، اقرَأِ السِّيناريوَ الإخباريَّ أعلاهُ وفَكِّرْ فيهِ بِنَقد. يُطلِقُ صاحِبُ المَصنَعِ ادِّعاءاتٍ خَطيرة: أنَّه لا خالِقَ يُراقِبُنا، وأنَّ لا أحَدَ يُحاسَبُ بَعدَ المَوت، وأنَّ الهِدايةَ الدِّينيّةَ بالِية. هذه تَمامًا هي الادِّعاءاتُ التي تَرُدُّ عَلَيها سورةُ السَّجدةِ بِقُوّة.\n\nأثناءَ كِتابةِ رَدِّكَ النّاقِدِ فَكِّرْ في الصِّلاتِ التّالية بِدَرسِنا:\n\u2022 السجدة ٢-٣ تُقَرِّرُ أنَّ القُرآنَ «الحَقُّ مِن رَبِّك» — لَيسَ كِتابًا بالِيًا بل هِدايةٌ إلهيّةٌ خالِدة.\n\u2022 السجدة ٤ تُذَكِّرُنا أنَّ اللهَ خَلَقَ السَّماواتِ والأرض — فَهو يَملِكُ الخَلق، وإتلافُهُ جُحودٌ بالنِّعمة.\n\u2022 السجدة ٧ تُفيدُ أنَّ اللهَ «أحسَنَ كُلَّ شَيءٍ خَلَقَه» — البِحارُ والكائِناتُ والأنظِمةُ البيئيّةُ تَصميمُهُ المُتقَن، لا يَحِقُّ لَنا إفسادُه.\n\u2022 السجدة ٩ تُخبِرُنا أنَّ اللهَ وَهَبَنا السَّمعَ والبَصَرَ والأفئِدةَ ثُمَّ قال «قَليلًا ما تَشكُرون» — صاحِبُ المَصنَعِ صورةٌ حَيّةٌ لِلجُحود.\n\u2022 السجدة ١٠-١١ تُؤَكِّدُ أنَّ مَلَكَ المَوتِ يَتَوَفّى كُلَّ نَفسٍ «ثُمَّ إلى رَبِّكُم تُرجَعون» — هُناكَ حِسابٌ بَعدَ المَوت.\n\u2022 السجدة ١٢ تَعرِضُ مَن أنكَروا الحَقَّ يَتَوَسَّلونَ الرُّجوعَ قائِلينَ «أبصَرنا وسَمِعنا» — لكِن بَعدَ فَواتِ الأوان.\n\nقالَ النَّبِيُّ \uFDFA: «إنَّ الدُّنيا خَضِرةٌ حُلوةٌ وإنَّ اللهَ مُستَخلِفُكُم فيها» (مسلم). ويُؤَكِّدُ العِلمُ أنَّ إلقاءَ الموادِّ الكيميائيّةِ السّامّةِ يُسَبِّبُ أضرارًا لا رَجعةَ فيها لِلأنظِمةِ البَحريّةِ وصِحّةِ الإنسان. فادِّعاءُ صاحِبِ المَصنَعِ أنَّ «الطَّبيعةَ تُصلِحُ نَفسَها» باطِلٌ عِلميًّا وأخلاقيًّا.\n\nاستَخدِمِ المِساحةَ أدناهُ لِبِناءِ رَدِّكَ النّاقِدِ الكامِلِ بِالأدِلّة.",
      },
    },
    {
