...
export const noonSakinahIzhar: CourseLesson = {
  ...
  name: { en: "Rules of Noon Sakinah and Tanwin: Clear Pronunciation (Izhar)", ar: "أحكامُ النّونِ السّاكِنةِ والتَّنوين: الإظهارُ الحَلقِيّ" },
  shortIntro: {
  ...
  sections: [
    {
      ...
      responsePrompt: {
        ...
        prompt: {
          en: "Criticise using evidence on tajweed importance and Izhar.",
          ar: "انتقد بأدلّة عن أهمّيّة التجويد والإظهار.",
        },
    ...
    },
    {
      ...
      imageMatchingActivity: {
        ...
        pairs: [
          ...
          { image: IMG.grandMosque, keyword: { en: "Izhar", ar: "الإظهار" } },
    ...
    {
      title: { en: "Rules of Noon Sakinah and Tanwin: Clear Pronunciation (Izhar)", ar: "أحكامُ النّونِ السّاكِنةِ والتَّنوين: الإظهارُ الحَلقِيّ" },
      learningObjectives: [
        { en: "Define Izhar and identify its letters.", ar: "أعرّف الإظهار وأحدّد حروفه." },
        { en: "Apply Izhar correctly in Quran recitation.", ar: "أطبّق الإظهار بشكل صحيح في التلاوة." },
      ],
      successCriteria: [
        { en: "I can define Izhar.", ar: "أعرّف الإظهار." },
        { en: "I can list the letters of Izhar.", ar: "أذكر حروف الإظهار." },
        { en: "I can identify Izhar in Quranic verses.", ar: "أحدّد الإظهار في الآيات القرآنيّة." },
      ],
      image: {
        src: IMG.childQuran,
    ...
    {
      title: { en: "Noon Sakinah and Tanween — Izhar", ar: "النون الساكنة والتنوين — الإظهار" },
      learningObjectives: [
        { en: "Master Izhar: Clear pronunciation of Noon Sakinah/Tanween before 6 throat letters.", ar: "أتقن الإظهار: النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق." },
      ],
      image: {
        src: IMG.childQuran,
      ...
      infoBoxes: [
        {
          label: { en: "What is Izhar?", ar: "ما الإظهار؟" },
          lines: [
            { en: "Clear pronunciation of Noon Sakinah/Tanween before 6 throat letters. It applies when Noon Sakinah or Tanween is followed by: ء ه ع ح غ خ.", ar: "النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق. ينطبق عندما تأتي النون الساكنة أو التنوين قبل: ء ه ع ح غ خ." },
          ],
        },
        {
          label: { en: "Letters of Izhar", ar: "حروف الإظهار" },
          lines: [
            { en: "The letters are: ء ه ع ح غ خ. Remember: أخي هاك علمًا حازه غير خاسر.", ar: "الحروف هي: ء ه ع ح غ خ. تذكّر: أخي هاك علمًا حازه غير خاسر." },
          ],
        },
        {
          label: { en: "Examples from Quran", ar: "أمثلة من القرآن" },
          lines: [
            { en: "مِنْ أَمْرِهِ — Izhar before ء. مِنْ عِلْمٍ — Izhar before ع. يَنْهَوْنَ — Izhar before ه.", ar: "مِنْ أَمْرِهِ — الإظهار قبل همزة. مِنْ عِلْمٍ — الإظهار قبل عين. يَنْهَوْنَ — الإظهار قبل هاء." },
          ],
        },
      ],
      trueFalseActivity: {
        ...
        questions: [
        { statement: { en: "Izhar means clear pronunciation of noon sakinah/tanween before 6 throat letters.", ar: "الإظهار يعني النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق." }, answer: true },
        { statement: { en: "There are 3 letters of Izhar.", ar: "هناك ٣ حروف الإظهار." }, answer: false },
        { statement: { en: "Izhar applies to Noon Sakinah and Tanween.", ar: "الإظهار ينطبق على النون الساكنة والتنوين." }, answer: true },
        { statement: { en: "Izhar means clear pronunciation.", ar: "الإظهار يعني النطق الواضح." }, answer: true },
      ...
      fillBlanksActivity: {
        ...
        questions: [
        { sentence: { en: "Izhar means _______.", ar: "الإظهار يعني _______." }, answer: { en: "clear pronunciation", ar: "الإظهار" } },
        { sentence: { en: "There are _______ letters of Izhar.", ar: "هناك _______ حرفًا في الإظهار." }, answer: { en: "6", ar: "6" } },
        { sentence: { en: "Izhar applies to Noon _______ and Tanween.", ar: "الإظهار ينطبق على النون _______ والتنوين." }, answer: { en: "Sakinah", ar: "الساكنة" } },
        { sentence: { en: "\'Recite the Quran with _______.\' (Al-Muzzammil 4)", ar: "﴿ورتّل القرآن _______.﴾ (المزّمّل ٤)" }, answer: { en: "tarteel", ar: "ترتيلًا" } },
        ],
        coinsReward: 10,
      },
      body: {
        en: "Izhar is a key tajweed rule for Noon Sakinah and Tanween. Clear pronunciation of Noon Sakinah/Tanween before 6 throat letters.",
        ar: "الإظهار حكم أساسي من أحكام النون الساكنة والتنوين. النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق.",
      },
    },
    {
      title: { en: "Group Work", ar: "عمل جماعي" },
      learningObjectives: [
        { en: "Practise identifying and applying Izhar in Quran.", ar: "تدرّب على تحديد وتطبيق الإظهار في القرآن." },
      ],
      image: {
        src: IMG.grandMosque,
        ...
        cards: [
          {
            ...
            color: "teal",
            topic: { en: "Master Izhar", ar: "أتقن الإظهار" },
            infoSections: [
              { label: { en: "Rule", ar: "قاعدة" }, content: { en: "Clear pronunciation of Noon Sakinah/Tanween before 6 throat letters. Letters: ء ه ع ح غ خ.", ar: "النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق. الحروف: ء ه ع ح غ خ." } },
              { label: { en: "Mnemonic", ar: "طريقة حفظ" }, content: { en: "Remember: أخي هاك علمًا حازه غير خاسر.", ar: "تذكّر: أخي هاك علمًا حازه غير خاسر." } },
            ...
            task: {
              ...
              description: { en: "Design a chart showing Izhar with letters and examples.", ar: "صمّم جدولًا يُظهر الإظهار مع الحروف والأمثلة." },
          ...
          },
          {
            ...
            task: {
              ...
              description: { en: "Find 10 examples of Izhar from Juz Amma.", ar: "أوجد ١٠ أمثلة الإظهار من جزء عمّ." },
          ...
          },
          {
            ...
            task: {
              ...
              description: { en: "Read 5 ayahs applying Izhar correctly.", ar: "اقرأ ٥ آيات بتطبيق الإظهار بشكل صحيح." },
              hint: { en: "Mark each Izhar instance.", ar: "حدّد كلّ حالة." },
            },
          },
          {
            id: "E",
            ...
            task: {
              ...
              description: { en: "Design a poster teaching Izhar to beginners.", ar: "صمّم ملصقًا لتعليم الإظهار للمبتدئين." },
    ...
    },
    {
      ...
      hingeQuestions: {
        ...
        questions: [
          {
            question: { en: "What does Izhar mean?", ar: "ما معنى الإظهار؟" },
            options: [
            { en: "Clear pronunciation of Noon Sakinah/Tanween before 6 throat letters", ar: "النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق" },
            { en: "Silence", ar: "صمت" },
            { en: "Shouting", ar: "صراخ" },
            { en: "Skipping", ar: "تخطّي" },
            ],
            correctIndex: 0,
            explanation: { en: "Clear pronunciation of Noon Sakinah/Tanween before 6 throat letters.", ar: "النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق." },
          },
          {
            question: { en: "How many letters of Izhar?", ar: "كم حرفًا في الإظهار؟" },
            options: [
            { en: "6", ar: "6" },
            { en: "2", ar: "٢" },
            { en: "10", ar: "١٠" },
          ...
          {
            question: { en: "Izhar applies to?", ar: "الإظهار ينطبق على؟" },
            options: [
          ...
          {
            question: { en: "Which is a letter of Izhar?", ar: "أيّ حرف من حروف الإظهار؟" },
            options: [
            { en: "ء", ar: "همزة" },
            { en: "ب", ar: "ب" },
            { en: "ت", ar: "ت" },
            ...
            correctIndex: 0,
            explanation: { en: "ء is a letter of Izhar.", ar: "همزة حرف الإظهار." },
          },
          {
            question: { en: "مِنْ أَمْرِهِ — what rule?", ar: "مِنْ أَمْرِهِ — أيّ حكم؟" },
            options: [
            { en: "Izhar", ar: "الإظهار" },
            { en: "Idgham", ar: "إدغام" },
            { en: "Waqf", ar: "وقف" },
            ...
            correctIndex: 0,
            explanation: { en: "Izhar.", ar: "الإظهار." },
          },
          {
    ...
    },
    {
      ...
      youtubeVideo: {
        title: { en: "Noon Sakinah — Izhar", ar: "النون الساكنة — الإظهار" },
    ...
    {
      title: { en: "Worksheet — Rules of Noon Sakinah and Tanwin: Clear Pronunciation (Izhar)", ar: "ورقة عمل — أحكامُ النّونِ السّاكِنةِ والتَّنوين: الإظهارُ الحَلقِيّ" },
      learningObjectives: [
        ...
        sections: [
          {
            ...
            questions: [
              {
                question: { en: "What is Izhar?", ar: "ما الإظهار؟" },
                options: [
                { en: "Clear pronunciation of Noon Sakinah/Tanween before 6 throat letters", ar: "النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق" },
                { en: "Silence", ar: "صمت" },
                { en: "Shouting", ar: "صراخ" },
              ...
              {
                question: { en: "مِنْ عِلْمٍ — rule?", ar: "مِنْ عِلْمٍ — حكم؟" },
                options: [
                { en: "Izhar", ar: "الإظهار" },
                { en: "Waqf", ar: "وقف" },
                { en: "Madd", ar: "مدّ" },
          ...
          },
          {
            ...
            title: { en: "True or False", ar: "صواب أم خطأ" },
            questions: [
              { statement: { en: "Izhar is a tajweed rule.", ar: "الإظهار حكم تجويدي." }, answer: true },
              { statement: { en: "There are 10 letters of Izhar.", ar: "هناك ١٠ حروف الإظهار." }, answer: false },
              { statement: { en: "Tajweed is obligatory.", ar: "التجويد واجب." }, answer: true },
              { statement: { en: "Izhar applies to Meem Sakinah.", ar: "الإظهار ينطبق على الميم الساكنة." }, answer: false },
              { statement: { en: "Noon Sakinah and Tanween both use Izhar.", ar: "النون الساكنة والتنوين كلاهما يستخدم الإظهار." }, answer: true },
            ],
          },
          {
            ...
            prompts: [
              { prompt: { en: "Izhar", ar: "الإظهار" }, answer: { en: "Clear pronunciation of Noon Sakinah/Tanween before 6 throat letters", ar: "النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق" } },
          ...
          },
          {
            ...
            title: { en: "Fill in the Blanks", ar: "املأ الفراغات" },
            questions: [
              { sentence: { en: "Izhar means _______.", ar: "الإظهار يعني _______." }, blankAnswer: { en: "izhar", ar: "النطق الواضح للنون الساكنة/التنوين قبل ٦ حروف حلق" } },
              { sentence: { en: "There are _______ letters of Izhar.", ar: "هناك _______ حرفًا." }, blankAnswer: { en: "6", ar: "6" } },
              { sentence: { en: "Izhar applies to Noon _______ and Tanween.", ar: "ينطبق على النون _______ والتنوين." }, blankAnswer: { en: "Sakinah", ar: "الساكنة" } },
          ...
          },
          {
            ...
            items: [
              ...
              { en: "Learn the definition of Izhar", ar: "تعلّم تعريف الإظهار" },
              { en: "Memorise the letters of Izhar", ar: "احفظ حروف الإظهار" },
              { en: "Identify Izhar in Quran", ar: "حدّد الإظهار في القرآن" },
              { en: "Practise correct pronunciation", ar: "تدرّب على النطق الصحيح" },
              { en: "Apply Izhar in full recitation", ar: "طبّق الإظهار في التلاوة" },
            ],
          },
        ],
        coinsReward: 25,
