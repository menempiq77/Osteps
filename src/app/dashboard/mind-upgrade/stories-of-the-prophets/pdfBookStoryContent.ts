export type PdfStoryContent = {
  shortIntro: string;
  sections: Array<{ title: string; body: string }>;
  quranSurahs: string[];
};

export const PDF_BOOK_STORY_CONTENT: Record<string, PdfStoryContent> = {
  "adam": {
    shortIntro: `(pbuh) and his son Seth (pbuh). Enoch was the 5th generation of the . He called the
...
certain days and to`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Adam
...
"The real joy of life is to have wisdom."`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `Prophet Nuh (N oah)
...
they became cruel and immoral.`
      ...
      {
        title: "Part 3: From the provided PDF",
        body: `Various Hadith describing the Origin of Idolatry 
...
target in life. (By worshipping anything other than Allah, man becomes enslaved to Satan, who is`
      ...
      {
        title: "Part 4: From the provided PDF",
        body: ``
      },
      {
        title: "Part 5: From the provided PDF",
        body: `himself a creature and becomes harnessed to his own baser qualities).
...
laborers, they started to verbally attack and taunt him: 'You are only followed by the poor, the`
      ...
      {
        title: "Part 6: From the provided PDF",
        body: ``
      },
      {
        title: "Part 7: From the provided PDF",
        body: `meek and the worthless.'
...
and insulted Allah's prophet:`
      ...
      {
        title: "Part 8: From the provided PDF",
        body: ``
      },
      {
        title: "Part 9: From the provided PDF",
        body: `“The leaders of his people said: "Verily, we see you in plain error." (Ch 7:60 Quran)
...
(names of the idols). Indeed they have led many astray. O Allah! Grant no increase to the`
      ...
      {
        title: "Part 10: From the provided PDF",
        body: ``
      },
      {
        title: "Part 11: From the provided PDF",
        body: `Zalimeen (polytheists, wrongdoers, and disbeliveers etc) save error."
...
And you will know who it is on whom will come a torment that will cover him with disgrace and`
      ...
      {
        title: "Part 12: From the provided PDF",
        body: `on whom will fall a lasting torment." (Ch 11:38-39 Quran)
The Flood begins
...
who had separated himself (apart), "O my son! Embark with us and be not with the disbeliveers."`
      ...
      {
        title: "Part 13: From the provided PDF",
        body: `The son replied, "I will betake myself to a mountain, it will save me from the water." Noah said:
...
www.islam basics.com`
      },
      {
        title: "Part 14: From the provided PDF",
        body: ``
      }
    ],
    quranSurahs: []
  ...
  "idris": {
    shortIntro: `Allah has praised Enoch, describing him as being a prophet and truthful: 
...
Birth and Teachings 
Enoch was born and raised in Babylon following the teachings and religion of`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Idris (Enoch)
...
Enoch was born and raised in Babylon following the teachings and religion of`
  ...
  "hud": {
    shortIntro: `Description of the People of Ad 
...
power and wealth, which, unfortunately, made them arrogant and boastful. Their political p`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Hud
...
suppose there is no Day of Judgment, then a great injustice will have prevailed, but Allah has`
      ...
      {
        title: "Part 3: From the provided PDF",
        body: `forbidden injustice to be incurred by Himself or His subjects. Therefore, the existence of the Day
...
is why you have become insane."`
      ...
      {
        title: "Part 4: From the provided PDF",
        body: `Almighty Allah repeated their words in the Quran: 
...
Almighty Allah recounts:`
      ...
      {
        title: "Part 5: From the provided PDF",
        body: `"Then when they saw it as a dense cloud coming towards their valleys, they said: "This is a cloud
...
www.islam basics.com`
  ...
  "salih": {
    shortIntro: `Description of the People of Thamud 
...
beautiful homes out of the hills. Tyranny and oppression became preval`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Salih 
...
followers, and they clung to their belief in Allah.`
      ...
      {
        title: "Part 3: From the provided PDF",
        body: `Stories About the She-camel 
...
that you may be affected by what afflicted them; so do no enter upon them."`
  ...
  "ibrahim": {
    shortIntro: `Prophet Ibrahim (peace be upon him), known as Abraham, stood as a towering model of pure monotheism, courage, patience, and complete trust in Allah. From breaking idols and facing the fire, to migration, fatherhood, sacrifice, and building the Ka'ba, his life is a chain of great tests met with unwavering faith and submission.`,
    sections: [
      {
        title: "Part 1: A Child of Tawhid in a Land of Idols",
        body: `Prophet Ibrahim (peace be upon him) was born in a society drowning in shirk. Some worshipped carved idols of stone and wood, some worshipped stars and planets, and some obeyed arrogant rulers as if they were gods. Even the home of Prophet Ibrahim (peace be upon him) was touched by this darkness, for his father (or uncle, according to some narrations) was among those who made and sold idols.

Yet Allah had chosen Prophet Ibrahim (peace be upon him) for guidance from his earliest years. His heart rejected false worship before his tongue had fully grown into the language of debate. As a child, Prophet Ibrahim (peace be upon him) watched people bow before statues that could not hear, see, speak, eat, or move. He asked simple questions that broke great illusions: How can what is created become a creator? How can what is helpless become a lord?

As Prophet Ibrahim (peace be upon him) grew, his reflection deepened. He observed the night sky and reasoned with his people step by step. When stars disappeared, when the moon set, when the sun itself vanished from the horizon, Prophet Ibrahim (peace be upon him) taught that what rises and falls cannot be the Eternal Lord. He declared that his face was turned only to Allah, the One Who created the heavens and the earth.

The Quran preserves this noble reasoning in Surah Al-An'am, where Prophet Ibrahim (peace be upon him) demonstrates certainty through reflection, not blind imitation. He did not argue to win applause. Prophet Ibrahim (peace be upon him) argued to rescue souls. He invited his people away from fear of created things and toward trust in the Creator of all things.

Then Prophet Ibrahim (peace be upon him) addressed his father with mercy and respect: O my father, do not worship what cannot hear or see. O my father, follow the path of guidance. Even while rejecting falsehood, Prophet Ibrahim (peace be upon him) kept noble manners. He combined firmness in creed with softness in speech.

But his people answered wisdom with anger. They mocked Prophet Ibrahim (peace be upon him), threatened him, and clung to inherited traditions. Still, Prophet Ibrahim (peace be upon him) did not retreat. He knew that truth is not measured by the number who follow it, but by the One who revealed it.`,
      },
      {
        title: "Part 2: The Broken Idols and the Fire That Could Not Burn",
        body: `When arguments failed to wake hearts, Prophet Ibrahim (peace be upon him) chose a practical lesson. During a public festival, when the town became empty, Prophet Ibrahim (peace be upon him) entered the temple where idols were decorated and food was placed before them. He spoke to them in irony: Why do you not eat? Why do you not speak?

Then Prophet Ibrahim (peace be upon him) struck the idols down, leaving only the largest one standing, and hung the axe on it. When people returned and saw their gods shattered, panic and rage spread. They brought Prophet Ibrahim (peace be upon him) before the public and demanded an answer.

With calm courage, Prophet Ibrahim (peace be upon him) said: Ask the big one, if it can speak. In that moment, their own minds testified against them. They knew the idols could not speak, defend themselves, or benefit anyone. Yet arrogance returned, and they chose punishment over repentance.

The chiefs ordered an immense fire to be prepared. Wood was gathered for days. The flames rose so high that they used a catapult to throw Prophet Ibrahim (peace be upon him) into the blaze. Bound and alone in the eyes of people, Prophet Ibrahim (peace be upon him) was never alone with Allah.

By Allah's command, the fire lost its nature: "O fire, be coolness and safety for Ibrahim." The same fire that was meant to destroy Prophet Ibrahim (peace be upon him) became peace for him. His ropes burned, but his body remained unharmed. Their plan collapsed, and the miracle stood before every eye.

This was not only a rescue. It was a sign for all ages: whoever puts full trust in Allah is never abandoned. Prophet Ibrahim (peace be upon him) emerged from the fire brighter in honor than before, and the tyrants were exposed as powerless before divine command.

Soon after, Prophet Ibrahim (peace be upon him) debated the king who claimed lordship. The king boasted that he gives life and death. Prophet Ibrahim (peace be upon him) answered with decisive proof: Allah brings the sun from the east, so bring it from the west. The arrogant ruler was silenced. Truth stood clear once more on the tongue of Prophet Ibrahim (peace be upon him).`,
      },
      {
        title: "Part 3: Migration, Family Trials, and Trust in Allah",
        body: `When rejection hardened and the call was resisted, Prophet Ibrahim (peace be upon him) migrated for Allah. He left homeland and familiarity, not for wealth or status, but to preserve and spread tawhid. Along this road traveled noble companions: Sarah, and Prophet Lut (peace be upon him), who believed in him.

Prophet Ibrahim (peace be upon him) moved between lands, calling people to righteousness and justice. In one journey with Sarah, a tyrant tried to harm her, but Allah protected her and humiliated the oppressor. Through that episode came Hajar into their household.

Years passed, and Sarah remained without children. Later, by Allah's decree, Hajar gave birth to Ismail (peace be upon him), and joy entered the house of Prophet Ibrahim (peace be upon him). But a greater test was ahead.

By divine command, Prophet Ibrahim (peace be upon him) took Hajar and the infant Ismail (peace be upon him) to a barren valley with no crops, no settlement, and no visible life: the valley of Makkah. He left with only limited provisions and turned away in obedience. Hajar asked whether this was Allah's command. When Prophet Ibrahim (peace be upon him) answered yes, she replied with certainty that Allah would not abandon them.

Prophet Ibrahim (peace be upon him) raised his hands and made a timeless dua: O our Lord, I have settled some of my offspring in a valley without cultivation near Your Sacred House, so that they may establish prayer. Fill hearts with love for them and provide them with fruits. This prayer of Prophet Ibrahim (peace be upon him) still echoes in every pilgrim heart.

From Hajar's struggle between Safa and Marwa, and by Allah's mercy through Jibril, the spring of Zamzam emerged. The barren valley became a center of life. Tribes settled there. Ismail (peace be upon him) grew, learned, married, and the destiny of a nation unfolded through the trust of Prophet Ibrahim (peace be upon him).`,
      },
      {
        title: "Part 4: Building the Ka'ba and the Test of Sacrifice",
        body: `When Ismail (peace be upon him) became strong enough to work beside his father, Allah commanded Prophet Ibrahim (peace be upon him) to raise the foundations of the Sacred House. Father and son built together, stone upon stone, in complete humility. As they built, Prophet Ibrahim (peace be upon him) and Ismail (peace be upon him) repeated: "Our Lord, accept from us. Indeed You are the All-Hearing, the All-Knowing."

Thus the Ka'ba was raised by the hands of Prophet Ibrahim (peace be upon him) and Ismail (peace be upon him), not as a monument of pride, but as a center of worship for Allah alone. Every prayer direction, every tawaf, every pilgrim who says "Labbaik" carries the legacy of Prophet Ibrahim (peace be upon him).

Then came the trial that shook hearts: Prophet Ibrahim (peace be upon him) saw in a dream that he must sacrifice his beloved son. The dream of prophets is revelation. Prophet Ibrahim (peace be upon him) shared it with his son, and Ismail (peace be upon him) answered with obedience: O my father, do what you are commanded; you will find me patient, if Allah wills.

Both submitted. Prophet Ibrahim (peace be upon him) prepared to fulfill the command with tears, certainty, and surrender. At the decisive moment, Allah called out that Prophet Ibrahim (peace be upon him) had fulfilled the vision and ransomed Ismail (peace be upon him) with a great sacrifice.

This event became a living symbol for believers: Islam is surrender to Allah above desire, fear, and attachment. The greatness of Prophet Ibrahim (peace be upon him) was not only in surviving trials, but in loving Allah more than everything else.

Allah honored Prophet Ibrahim (peace be upon him) with enduring praise among later generations: peace be upon Ibrahim. His name became attached to faith itself, to prayer itself, and to the path of sincere devotion.`,
      },
      {
        title: "Part 5: Glad Tidings, Certainty, and Lasting Legacy",
        body: `After long years of struggle, Allah sent angels to Prophet Ibrahim (peace be upon him) in human form. He welcomed them generously and hurried to serve food. When they did not eat, Prophet Ibrahim (peace be upon him) felt concern, and they reassured him that they were messengers from Allah.

They gave glad tidings of Ishaq (peace be upon him), and after him Yaqub (peace be upon him). Sarah, elderly and amazed, wondered how this could be. The angels reminded the family of Prophet Ibrahim (peace be upon him) that Allah's decree is beyond human limits.

Prophet Ibrahim (peace be upon him) also asked Allah to show how the dead are brought back to life, not out of doubt, but to increase inner certainty. Allah commanded him regarding the birds, and the sign was shown. The heart of Prophet Ibrahim (peace be upon him) became even more tranquil in faith.

Through Ismail (peace be upon him) and Ishaq (peace be upon him), the blessed lineage of prophets spread. From this house came Yaqub (peace be upon him), Yusuf (peace be upon him), Musa (peace be upon him), Dawud (peace be upon him), Sulayman (peace be upon him), Zakariyya (peace be upon him), Yahya (peace be upon him), Isa (peace be upon him), and finally Muhammad (peace and blessings be upon him), who revived the pure religion of Prophet Ibrahim (peace be upon him).

For this reason, Prophet Ibrahim (peace be upon him) is remembered as Khalilullah, the intimate friend of Allah, and as an imam for humanity in faith, character, and surrender. His story teaches that one truthful heart can confront an entire civilization of falsehood.

Lessons from the life of Prophet Ibrahim (peace be upon him):
- Believe with evidence and reflection, not imitation.
- Speak truth with wisdom, patience, and courage.
- Trust Allah when the road appears empty and dry.
- Obey Allah even when sacrifice reaches what is most beloved.
- Build for Allah sincerely, as Prophet Ibrahim (peace be upon him) built the Ka'ba.

Whoever walks the path of Prophet Ibrahim (peace be upon him) learns that tests are not signs of abandonment; they are doors to nearness, purification, and honor with Allah.`
      }
    ],
    quranSurahs: [
      "Al-Baqarah (Sura 2)",
  ...
  "ismail": {
    shortIntro: `Abraham leaves Hajar and Ishmael 
...
mountains until he reached the desert of the Arabian Peninsula and came to an uncultivated v`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Isma'il (Ishmael)
...
"Yes." She then said: "Then He will not neglect us," and returned while Abraham proceeded`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `onwards. On reaching the Thaniya where they could not see him, he faced the Kaba and raising
...
running between Safa And Marwa seven times."
 Hajar sees Zam-zam - by`
      }
    ],
    quranSurahs: []
  },
  "ishaq": {
    shortIntro: `Prophet Ishaq (peace be upon him), known as Isaac, was the blessed son of Prophet Ibrahim (peace be upon him) and his wife Sarah. He was born when his parents were very advanced in age, as a miraculous gift from Allah after years of longing for a child. Prophet Ishaq (peace be upon him) was one of the noble prophets chosen by Allah to continue the legacy of pure monotheism and to carry forward the light of divine guidance through his descendants. He married Rebekah and was blessed with twin sons, Esau and Yaqub (Jacob), through whom many prophets would come. His life was a testament to Allah's promise, patience, and the continuation of Abraham's blessed lineage.`,
    sections: [
      {
        title: "Part 1: The Miraculous Birth - A Promise Fulfilled",
        body: `Prophet Ishaq (peace be upon him) - The Long-Awaited Gift from Allah

The Noble Birth of a Blessed Prophet

Prophet Ishaq (peace be upon him), known as Isaac in English, holds a profoundly special place in the hearts of believers as one of the chosen prophets of Allah and the beloved son of the great Prophet Ibrahim (peace be upon him), the Friend of Allah. His birth was not an ordinary event - it was a divine miracle, a fulfillment of Allah's sacred promise, and a testament to the infinite power of the Almighty to bring about the impossible when He wills.

The story of Prophet Ishaq's (peace be upon him) birth is intertwined with one of the most beautiful demonstrations of Allah's mercy and power recorded in the Quran and passed down through authentic Islamic traditions.

Prophet Ibrahim (peace be upon him) and Sarah - Years of Patient Waiting

Prophet Ibrahim (peace be upon him) had devoted his entire life to calling people to worship Allah alone, abandoning the idolatry of his forefathers and standing firm against all opposition. His wife Sarah stood beside him through all the trials and tribulations, sharing his unwavering faith and dedication to the Truth.

Yet despite their righteousness and their complete submission to Allah's will, Prophet Ibrahim (peace be upon him) and Sarah faced a profound personal trial - they were blessed with wealth, honor, and the love of believers, but for many long years, they had no children. Sarah was barren, unable to conceive, and as the years passed and both she and Prophet Ibrahim (peace be upon him) advanced in age, the natural possibility of having children seemed to fade away entirely.

This trial tested their patience and their trust in Allah's wisdom. They never complained or despaired, for they knew that Allah is the Best of Planners, and that He decrees all things according to His perfect knowledge and infinite wisdom.

The Divine Visitors - Angels Bearing Glad Tidings

One fateful day, when Prophet Ibrahim (peace be upon him) was living in the blessed land near what would later become Jerusalem, he received unexpected visitors. Three strangers approached his dwelling - dignified, noble in appearance, radiating an aura of purity and majesty that immediately caught his attention.

Prophet Ibrahim (peace be upon him), known throughout history for his exceptional hospitality and generosity, immediately welcomed the visitors with the warmest reception. He hastened to prepare food for them, following the noble custom of honoring guests that was the hallmark of the people of faith.

He went to his livestock, selected a healthy, fat calf - choosing the very best he had to offer - and had it roasted until it was tender and perfectly prepared. Then he presented this generous feast before his guests with humble respect and sincere warmth.

But as he watched them, something extraordinary occurred. The visitors did not reach out to eat the food placed before them. Their hands did not extend toward the meal. They simply sat in dignified silence, not touching the food that had been prepared with such care.

Prophet Ibrahim (peace be upon him) was perplexed and began to feel a sense of unease. In the culture of the time, refusing to eat a host's food was often a sign of enmity or ill intent. Why would these noble-looking visitors refuse his hospitality? Who were these mysterious strangers who would not partake of his food?

Allah the Most High describes this moment in the Quran:

"Has the story reached you of the honored guests of Ibrahim (Abraham)? When they entered upon him and said: 'Peace!' He answered: 'Peace!' and said: 'You are a people unknown to me.' Then he turned to his household and brought out a roasted calf. And placed it before them, saying: 'Will you not eat?' Then he conceived fear of them. They said: 'Fear not!' And they gave him glad tidings of a son having knowledge." (Surah Adh-Dhariyat 51:24-28)

As Prophet Ibrahim (peace be upon him) began to feel a sense of concern at their refusal to eat, the visitors finally spoke. Their voices were gentle yet carried an authority that immediately calmed his heart. They said, "Do not be afraid, O Ibrahim. We are not human beings who require earthly food. We are angels, messengers sent by Allah with a special message for you and your wife."

The Miraculous Announcement

With these words, Prophet Ibrahim's (peace be upon him) fear transformed into awe and anticipation. Angels! Divine messengers from Allah had come to his home! What message could they possibly bring?

The angels continued, and their words would forever change the lives of Prophet Ibrahim (peace be upon him) and Sarah. They said:

"We bring you glad tidings of a son - a knowledgeable, wise son who will be a prophet like you."

These words struck Prophet Ibrahim (peace be upon him) with overwhelming joy mixed with astonishment. A son? After all these years? When both he and Sarah had grown so old that such a thing seemed completely impossible by any natural means?

Sarah's Astonishment - Human Nature Meets Divine Power

When Sarah heard the angels' announcement - for she had emerged when she heard the conversation - her reaction was one of pure, instinctive human astonishment. The Quran beautifully preserves her response:

"Then his wife came forward with a loud voice; she smote her face and said: 'A barren old woman! How can this be?'" (Surah Adh-Dhariyat 51:29)

Sarah was expressing what any human being would naturally feel in such a situation. She was an elderly woman, well beyond the age of childbearing. Moreover, she had been barren all her life, unable to conceive even in her youth when such a thing would have been naturally possible. How could she possibly give birth now, in her advanced age?

Some narrations mention that Sarah was ninety years old at this time, while Prophet Ibrahim (peace be upon him) was one hundred years old. By any human measure, conception and childbirth were absolutely impossible.

But the angels' response taught her - and teaches all of us - a profound lesson about the nature of Allah's power:

"They said: 'Do you wonder at the Decree of Allah? The Mercy of Allah and His Blessings be upon you, O people of the house! Surely, He is All-Praiseworthy, All-Glorious.'" (Surah Hud 11:73)

The angels gently reminded Sarah that nothing is impossible for Allah. He is the Creator of all things, the One who brings life from death, who creates from nothing, who makes the impossible possible by His mere command "Be!" and it is.

If Allah had decreed that she would bear a child in her old age, then it would surely happen, regardless of how impossible it might seem by worldly standards. This was not subject to the normal laws of nature - this was a direct miracle from Allah, a sign of His infinite power and a fulfillment of His promise.

The Promise Fulfilled - The Birth of Prophet Ishaq (peace be upon him)

And so it came to pass, exactly as the angels had foretold. Sarah conceived by the will of Allah, and when the appointed time arrived, she gave birth to a beautiful, healthy baby boy.

The joy that filled the household of Prophet Ibrahim (peace be upon him) cannot be described in words. After decades of waiting, after years of patient endurance and steadfast faith, Allah had blessed them with a son in their old age - a son who was not just any child, but one whom Allah had already designated to be a prophet, a bearer of divine knowledge and wisdom.

They named him Ishaq - Isaac - a name that in Hebrew means "he will laugh" or "laughter," symbolizing the joy and wonder of his miraculous birth.

Allah the Almighty mentions this blessed event in several places in the Quran:

"And We gave him glad tidings of Ishaq (Isaac), a prophet from among the righteous. We blessed him and Ishaq (Isaac), and of their progeny are some that do right, and some that plainly wrong themselves." (Surah As-Saffat 37:112-113)

The birth of Prophet Ishaq (peace be upon him) was not just a personal blessing for Prophet Ibrahim (peace be upon him) and Sarah - it was a fulfillment of Allah's promise to continue the line of prophets through Ibrahim's descendants, ensuring that the message of pure monotheism would be carried forward through the generations.

Prophet Ishaq (peace be upon him) represented the continuation of the sacred covenant between Allah and the children of Prophet Ibrahim (peace be upon him), a covenant that would produce many prophets and righteous people who would guide humanity toward the light of faith and submission to the One True God.

The Wisdom Behind the Delay

Looking back at the long years of waiting before Prophet Ishaq's (peace be upon him) birth, we can see profound wisdom in Allah's timing:

**Testing and Strengthening Faith:** The delay tested Prophet Ibrahim (peace be upon him) and Sarah's patience and trust in Allah, deepening their reliance on Him alone.

**Demonstrating Divine Power:** By making the birth occur when it was naturally impossible, Allah demonstrated His absolute power over all natural laws, showing that He alone gives life and death, and that nothing is beyond His capability.

**Making the Blessing More Precious:** The long wait made the gift of Prophet Ishaq (peace be upon him) even more precious and appreciated, teaching us that sometimes Allah delays our prayers not to deny us, but to give us something better at the perfect time.

**A Sign for All Believers:** The miraculous birth became an eternal sign for all believers that with Allah, nothing is impossible, and that we should never despair of His mercy no matter how hopeless our situation may appear.`
      },
      {
        title: "Part 2: Growing Up in a Blessed Household",
        body: `A Childhood of Faith and Righteousness

Growing Up Under the Care of Prophet Ibrahim (peace be upon him)

Prophet Ishaq (peace be upon him) grew up in one of the most blessed households in all of human history - the home of Prophet Ibrahim (peace be upon him), the Friend of Allah, and his devoted wife Sarah. From his earliest days, young Ishaq (peace be upon him) was surrounded by an atmosphere of pure faith, unwavering devotion to Allah, and dedication to calling people to the Truth.

Prophet Ibrahim (peace be upon him), known throughout history for his exceptional character, his courage in standing against falsehood, and his complete submission to Allah's will, raised his son with the same values that had guided his own life. Every day, young Ishaq (peace be upon him) witnessed his father's prayers, his remembrance of Allah, his generosity to guests, and his tireless efforts to guide people away from idolatry toward the worship of the One True God.

Sarah, his mother, lavished upon him the love and care that she had stored up during all those years of waiting for a child. Yet this love was balanced with wisdom and proper upbringing in the ways of faith and righteousness. She taught him respect, humility, gratitude to Allah, and the importance of following in his father's noble footsteps.

Learning the Ways of Prophethood

As Prophet Ishaq (peace be upon him) grew from childhood into youth and then young manhood, Prophet Ibrahim (peace be upon him) personally undertook his religious education and spiritual development. He taught him:

**The Oneness of Allah (Tawhid):** The fundamental truth that there is no deity worthy of worship except Allah alone, without partners, associates, or intermediaries - the same message that Prophet Ibrahim (peace be upon him) had proclaimed fearlessly throughout his life, even when it meant standing alone against his entire society.

**The Principles of Worship:** How to pray, how to remember Allah, how to express gratitude for His blessings, and how to maintain constant consciousness of the divine presence in every aspect of life.

**The Stories of Earlier Prophets:** Prophet Ibrahim (peace be upon him) passed down the knowledge of previous prophets and messengers, teaching young Ishaq (peace be upon him) about Prophet Nuh (Noah - peace be upon him), and the other righteous servants of Allah who had come before.

**Moral Excellence and Good Character:** The importance of truthfulness, honesty, justice, mercy, patience, and all the noble qualities that befitted someone who would one day be entrusted with prophethood.

**The Responsibility of Carrying the Message:** Prophet Ibrahim (peace be upon him) helped his son understand that he was not born merely to live a comfortable life, but to continue the sacred mission of calling people to Allah and preserving the pure monotheistic faith.

Through this comprehensive upbringing, Prophet Ishaq (peace be upon him) developed into a young man of exceptional piety, knowledge, and spiritual maturity - perfectly prepared for the role that Allah had destined for him.

The Special Status of Two Blessed Sons

Prophet Ishaq (peace be upon him) was not the only son of Prophet Ibrahim (peace be upon him). He had an older brother, Prophet Ismail (Ishmael - peace be upon him), born to Hajar (Hagar). Despite being born to different mothers and raised in different locations - Ismail in Makkah and Ishaq in the blessed land of Sham (Greater Syria/Palestine) - both brothers were equally beloved to their father and both were chosen by Allah to be prophets.

The Quran mentions them together in several places, honoring both as righteous and blessed:

"And We blessed him with Ishaq (Isaac) and Yaqub (Jacob), each one We made righteous. And We made them leaders, guiding by Our Command, and We revealed to them the doing of good deeds, performing prayers, and giving of charity, and they were worshippers of Us alone." (Surah Al-Anbiya 21:72-73)

This demonstrates an important principle: Allah distributed His blessings and His choosing of prophets across Prophet Ibrahim's (peace be upon him) descendants through both lines, and both sons were equally honored and blessed despite their different circumstances.

The Test of Patience and Wisdom

Though the Quran and authentic traditions do not give us detailed stories of specific trials that Prophet Ishaq (peace be upon him) faced during his youth, we can infer that growing up as the son of such a prominent prophet would have come with its own unique challenges:

**Living Up to High Expectations:** Being the son of Prophet Ibrahim (peace be upon him) - one of the greatest prophets in history - meant that eyes were always upon him, and people expected him to exemplify the same level of faith and righteousness as his father.

**Maintaining Humility:** Despite being born to such a blessed lineage and being told from childhood that he would be a prophet, Prophet Ishaq (peace be upon him) had to maintain perfect humility and remember that all blessings come from Allah alone, not from one's own merit.

**Preparing for Leadership:** Knowing that he would one day carry the responsibility of guiding people and continuing his father's mission required serious spiritual and intellectual preparation from a young age.

All evidence suggests that Prophet Ishaq (peace be upon him) met these challenges with exemplary patience, wisdom, and devotion to Allah, earning through his own righteousness the station that Allah had promised him even before his birth.

A Prophet in His Own Right

When Prophet Ishaq (peace be upon him) reached maturity and the appointed time arrived, Allah bestowed upon him the mantle of prophethood. He was not merely "the son of Ibrahim" - he became Prophet Ishaq (peace be upon him), a messenger of Allah in his own right, chosen and blessed by the Almighty to carry forward the divine message.

Allah describes him in the Quran with the highest words of praise:

"And We gave him the glad tidings of Ishaq (Isaac), a prophet from the righteous." (Surah As-Saffat 37:112)

He was tasked with the same fundamental mission that all prophets share: to call people to worship Allah alone, to establish justice and righteousness, to teach divine wisdom, and to guide humanity away from the darkness of ignorance, superstition, and idolatry toward the light of faith and truth.

Though he lived in the shadow of his father's towering legacy, Prophet Ishaq (peace be upon him) carved out his own path of righteousness and became a beacon of guidance for his people, worthy of the trust that Allah had placed in him.`
      },
      {
        title: "Part 3: Marriage, Family, and Continuing the Blessed Lineage",
        body: `The Marriage of Prophet Ishaq (peace be upon him) - Choosing a Righteous Partner

When Prophet Ishaq (peace be upon him) reached the age when it was appropriate for him to marry, Prophet Ibrahim (peace be upon him) was very particular about choosing the right wife for his beloved son. He did not want Ishaq (peace be upon him) to marry from among the Canaanites who inhabited the land around them, for these people were polytheists who worshipped idols and had strayed far from the path of true monotheism.

Prophet Ibrahim (peace be upon him) desired that his son marry a woman from among his own extended family - people who still maintained some connection to the pure faith and would be more likely to support Prophet Ishaq (peace be upon him) in his divine mission rather than leading him astray.

So Prophet Ibrahim (peace be upon him) sent a trustworthy servant on a long journey to Haran, in the land of Iraq (Mesopotamia), where some of his relatives still lived. The servant was given clear instructions: find a suitable, righteous bride from among Ibrahim's family for his son Ishaq.

The Journey to Find a Bride

The faithful servant undertook this important mission with dedication and prayer. When he arrived in Haran, he prayed to Allah for guidance and success, asking the Almighty to guide him to the right woman who would be a suitable partner for Prophet Ishaq (peace be upon him).

According to the traditions passed down to us, the servant's choice fell upon Rebekah (Rifqah), the daughter of Bethuel, who was himself the son of Nahor - and Nahor was the brother of Prophet Ibrahim (peace be upon him). Thus, Rebekah was Prophet Ibrahim's (peace be upon him) grandniece, from his own extended family, exactly as he had hoped.

The servant observed Rebekah and was impressed by her character. She demonstrated kindness, hospitality, and willingness to serve others - all noble qualities that indicated a good heart and righteous nature. After making the necessary arrangements and receiving the agreement of her family, the servant returned with Rebekah to the land of Canaan where Prophet Ishaq (peace be upon him) awaited.

A Blessed Marriage

When Prophet Ishaq (peace be upon him) met Rebekah, he was pleased with her, and they were married. The marriage was blessed by Allah, and Rebekah proved to be a righteous, supportive wife who shared her husband's commitment to faith and righteousness.

The traditions tell us that Prophet Ishaq (peace be upon him) was forty years old when he married Rebekah during the lifetime of his father, Prophet Ibrahim (peace be upon him). This means that Prophet Ibrahim (peace be upon him), despite his advanced age, lived long enough to see his son happily married and to enjoy the blessings of having a daughter-in-law in the household.

The Trial of Childlessness

However, soon after their marriage, Prophet Ishaq (peace be upon him) and Rebekah faced a trial that echoed the test his own parents had endured - Rebekah was unable to conceive children. She was barren, and despite the passage of time, no children came.

This was a particularly difficult trial for Prophet Ishaq (peace be upon him), who had himself been born as a miraculous answer to his parents' prayers after years of waiting. He understood the pain of longing for children, for he had heard the story of his own birth countless times from his mother Sarah.

But rather than despairing or complaining, Prophet Ishaq (peace be upon him) responded exactly as a prophet should - he turned to Allah in sincere supplication and prayer.

The Power of Sincere Prayer

Prophet Ishaq (peace be upon him) raised his hands to the heavens and prayed earnestly to his Lord, asking Allah to bless him and Rebekah with righteous children. He prayed with complete faith, trusting that Allah, who had given him life when his mother was old and barren, was certainly capable of blessing Rebekah with children despite her condition.

And Allah, the Most Merciful, the All-Hearing, the Responder to prayers - He answered the sincere supplication of His prophet.

Rebekah conceived by the will and mercy of Allah. The One who had brought Prophet Ishaq (peace be upon him) himself into existence as a miracle now granted him his own miracle - the blessing of children after years of patient waiting and fervent prayer.

The Birth of Twin Sons - Esau and Yaqub (Jacob)

When the time of delivery arrived, Rebekah gave birth not to one child, but to twin sons - a double blessing from Allah that filled the household with joy and gratitude.

The first twin to emerge was named Esau (Al-'Eis in Arabic), and his brother who followed was named Yaqub (Jacob). From the very beginning, even as infants, the two brothers were quite different from each other in appearance and temperament - differences that would become more pronounced as they grew.

Allah's Special Blessing Upon Yaqub (Jacob)

While both sons were beloved to their parents, Allah in His infinite wisdom chose to bestow the gift of prophethood specifically upon Yaqub (Jacob - peace be upon him), making him the continuation of the prophetic line through Prophet Ishaq (peace be upon him).

The Quran mentions this divine selection:

"And We bestowed upon him Ishaq (Isaac), and as a gift, Yaqub (Jacob), and We made each of them righteous. And We made them leaders, guiding by Our Command, and We revealed to them the doing of good deeds, establishing regular prayers, and giving of charity, and they were worshippers of Us alone." (Surah Al-Anbiya 21:72-73)

Thus, through Prophet Yaqub (peace be upon him), the blessed lineage continued, and from him came the twelve tribes of Israel (named after Yaqub's alternative name, Israel), which would produce many prophets in subsequent generations, including Prophet Yusuf (Joseph - peace be upon him), Prophet Musa (Moses - peace be upon him), Prophet Harun (Aaron - peace be upon him), Prophet Dawud (David - peace be upon him), Prophet Sulaiman (Solomon - peace be upon him), Prophet Zakariyya (Zechariah - peace be upon him), Prophet Yahya (John - peace be upon him), and finally Prophet Isa (Jesus - peace be upon him).

All of these noble prophets were descendants of Prophet Ishaq (peace be upon him) through his son Yaqub, making Prophet Ishaq's (peace be upon him) legacy one of the most blessed in all of human history.

The Differences Between Esau and Yaqub

As the twin brothers grew from childhood into adulthood, their different natures became increasingly apparent. Esau was more worldly in his interests and pursuits, while Yaqub (peace be upon him) was more inclined toward spirituality, worship, and the pursuit of divine knowledge.

The traditions tell us that Prophet Ishaq (peace be upon him) felt a special closeness to Yaqub because of his son's righteous character and spiritual inclinations. This favoritism, combined with Allah's selection of Yaqub for prophethood, created tension between the brothers that would eventually lead to conflict.

According to some narrations, Esau developed feelings of envy and resentment toward his brother Yaqub (peace be upon him). He disliked the fact that their father seemed to favor Yaqub, and he was particularly disturbed that Allah had chosen his brother for prophethood rather than him.

These negative feelings grew over time until they became so intense that Esau actually began to threaten Yaqub's (peace be upon him) life, creating a serious crisis within the family.

A Father's Wisdom and Grief

For Prophet Ishaq (peace be upon him), this conflict between his sons must have been a source of profound sadness. He loved both his children, and seeing them at odds with each other - especially knowing that the conflict arose from envy over spiritual blessings - would have grieved his fatherly heart.

Yet as a prophet and a wise father, he understood that he could not force his sons to love each other, nor could he change the decree of Allah regarding who would be chosen for prophethood. All he could do was counsel them both, remind them of the importance of brotherly love and family harmony, and pray that Allah would guide them and heal the rift between them.

Eventually, to protect Yaqub (peace be upon him) from his brother's threats and to preserve peace within the family, the decision was made that Yaqub should leave and travel to the land of Haran, where he could stay with his maternal uncle and be safe from Esau's anger.

This separation was difficult for Prophet Ishaq (peace be upon him), but he trusted in Allah's wisdom and knew that ultimately, all matters are in Allah's hands.`
      },
      {
        title: "Part 4: Final Years and Death - The End of a Blessed Life",
        body: `The Later Life of Prophet Ishaq (peace be upon him)

The Final Chapter of a Righteous Life

After many years, during which Prophet Yaqub (peace be upon him) lived away from home to escape his brother's enmity, there came a time when Yaqub returned to the land of Canaan. He came back to his father Prophet Ishaq (peace be upon him), and they were reunited after the long separation.

The traditions tell us that Prophet Yaqub (peace be upon him) settled with his father in the village of Hebron (Al-Khalil in Arabic), located in the land of Canaan (Palestine). This was the same blessed region where Prophet Ibrahim (peace be upon him) had lived and where he was eventually buried.

Being reunited with his righteous son Yaqub (peace be upon him) must have brought great comfort and joy to Prophet Ishaq (peace be upon him) in his final years. After the pain of seeing his sons in conflict and the sadness of the long separation, he could now spend his remaining days in the company of his blessed son who had been chosen for prophethood like himself.

A Full Life of Service to Allah

By this time, Prophet Ishaq (peace be upon him) had lived a long, full life devoted entirely to the worship of Allah and the guidance of people toward the pure monotheistic faith. Though the specific details of his prophetic mission are not extensively recorded in the Quran or authentic traditions, we know from Allah's testimony in the Quran that he fulfilled his responsibility with complete righteousness.

Allah honors him in the Quran by mentioning him alongside the greatest prophets:

"And remember Our servants, Ibrahim (Abraham), Ishaq (Isaac), and Yaqub (Jacob), possessors of strength and vision. Verily, We chose them for a pure purpose - to remind people of the Hereafter. And they are with Us, truly, among the chosen and the best." (Surah Sad 38:45-47)

This divine testimony confirms that Prophet Ishaq (peace be upon him) was:

**Chosen by Allah:** Selected from among all of humanity for the special role of prophethood.

**Possessed of Strength and Vision:** Endowed with spiritual strength, inner fortitude, and clear insight into the truth.

**Devoted to reminding people of the Hereafter:** Dedicated to keeping people's focus on their ultimate destiny and accountability before Allah.

**Among the Chosen and the Best:** Ranked with the most excellent of all human beings - the prophets and messengers.

The Passing of Prophet Ishaq (peace be upon him)

When Prophet Ishaq's (peace be upon him) appointed time drew near and the end of his earthly life approached, he faced death with the same faith, patience, and submission to Allah's will that had characterized his entire existence.

The historical traditions state that Prophet Ishaq (peace be upon him) lived to the age of one hundred and eighty years - a long life by any measure, filled with worship, service, and the fulfillment of his prophetic mission.

When he finally passed away, his sons Esau and Yaqub (peace be upon him) came together, putting aside whatever differences remained between them, to fulfill their sacred duty to their father. Together, they prepared his body for burial and carried him to be laid to rest.

Buried with His Father - A Family Reunion in Death

Prophet Ishaq (peace be upon him) was buried in the same sacred cave where his father, Prophet Ibrahim (peace be upon him), had been laid to rest before him. This cave, located in Hebron, had been purchased by Prophet Ibrahim (peace be upon him) specifically as a family burial site.

This reunion in death with his beloved father - the one who had raised him, taught him, shaped his character, and prepared him for prophethood - is a beautiful symbol of the continuity and connection between the generations of prophets, each building upon the legacy of those who came before.

Some narrations also mention that Prophet Ibrahim (peace be upon him) had passed away at the age of one hundred and seventy-five, and that he too was buried in this cave. Thus, father and son rested together, their earthly journey complete, awaiting the Day of Resurrection when they would rise again to meet their Lord.

The Eternal Legacy of Prophet Ishaq (peace be upon him)

Though his story in the Quran is not as extensively detailed as those of some other prophets, the legacy of Prophet Ishaq (peace be upon him) is immense and enduring:

**Continuing the Prophetic Line:** Through his son Yaqub (peace be upon him), he became the ancestor of countless prophets, including some of the greatest in history. Every prophet from the Children of Israel traces their lineage back through him.

**Embodying Patient Faith:** His life exemplified patient trust in Allah's timing, from his miraculous birth to his answered prayers for children.

**Maintaining Monotheism:** Like his father before him, he upheld the pure worship of Allah alone and passed this precious legacy on to his descendants.

**An Example of Righteous Living:** His consistent devotion, good character, and fulfillment of his prophetic responsibilities make him an eternal model for believers.

Lessons from the Life of Prophet Ishaq (peace be upon him)

The story of Prophet Ishaq (peace be upon him), though brief in its Quranic telling, contains profound lessons for all believers:

**Allah's Promises Are Always Fulfilled:** Just as Allah fulfilled His promise to give Ibrahim (peace be upon him) a righteous son despite the seeming impossibility, He will fulfill His promises to us when we remain patient and faithful.

**Nothing Is Impossible for Allah:** The miraculous birth of Prophet Ishaq (peace be upon him) reminds us that Allah's power transcends all natural laws. When He decrees something, He simply says "Be!" and it is.

**The Importance of Righteous Upbringing:** The careful, faith-centered way in which Prophet Ibrahim (peace be upon him) raised Ishaq (peace be upon him) shows us the critical importance of proper Islamic education and spiritual development of our children.

**Sincere Prayer Brings Results:** When Ishaq (peace be upon him) and Rebekah faced childlessness, his sincere prayers to Allah brought divine response, teaching us to turn to Allah with our needs and trust in His wisdom.

**Maintaining Family Ties Despite Differences:** Even after the conflicts between Esau and Yaqub, the brothers came together to honor their father at his death, reminding us of the importance of family bonds and forgiveness.

**The Continuity of Divine Guidance:** Through Prophet Ishaq (peace be upon him), the message of pure monotheism was preserved and passed down through generations, showing Allah's commitment to ensuring humanity always has access to divine guidance.

May Allah's peace and blessings be upon Prophet Ishaq (peace be upon him), his father Prophet Ibrahim (peace be upon him), his mother Sarah, his wife Rebekah, his sons, and all the prophets who came from his blessed lineage. May we learn from their examples and follow in their footsteps of complete submission to Allah. Ameen.`
      }
    ],
    quranSurahs: ["Maryam (Sura 19)", "Al-Anbiya (Sura 21)", "As-Saffat (Sura 37)", "Sad (Sura 38)", "Hud (Sura 11)", "Adh-Dhariyat (Sura 51)"]
  },
  "yaqub": {
    shortIntro: `Isaac's Sons - Jacob and Esau 
...
prophethood. This ill feeling became so serious that Esau threatened to kill his brother. Fearin`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Yaqub (Jacob)
...
and multiply his sustenance and fruits.`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `When their mother knew that Esau threatened his brother Jacob, she commanded her son Jacob to
...
Jacob.`
      ...
      {
        title: "Part 4: From the provided PDF",
        body: `Then Rachel prayed to Allah to give her a son from Jacob. Allah heard her call and responded to
...
returned greetings and told Jacob that Esau was riding towards him with four hundred men. This`
      ...
      {
        title: "Part 6: From the provided PDF",
        body: `made Jacob afraid and he entreated and prayed to Allah Almighty. He prostrated in humiliation
...
mentioned before.`
      ...
      {
        title: "Part 8: From the provided PDF",
        body: `Dinah's Story - from the People of the Book 
...
you worship after me?" They said: "We shall worship you (Ilah (God - Allah) the Ilah (God) of`
      ...
      {
        title: "Part 10: From the provided PDF",
        body: `your fathers, Abraham, Ishmael, Isaac, One Ilah (God), and to Him we submit (in Islam)."
...
ignorance and afterward repent and do righteous deeds, verily, your Lord thereafter to such is`
      ...
      {
        title: "Part 11: From the provided PDF",
        body: `Oft Forgiving, Most Merciful.
...
in his household, not all the members believed. Lot's wife, like Noah's wife, a disbeliever.
 Allah the Almighty declared:`
      ...
      {
        title: "Part 13: From the provided PDF",
        body: `"Allah set forth an example for those who disbelieve, the wife of Noah and the wife of Lot. They
...
He pleaded with them to leave the visitors alone and fear Allah's punishment. He urged them to`
      ...
      {
        title: "Part 15: From the provided PDF",
        body: `seek sexual fulfillment with their wives, for that is what Allah had made lawful.
...
(people of the city) said: "Did we not forbid you to entertain (or protect) any of the Alamin`
      ...
      {
        title: "Part 16: From the provided PDF",
        body: `(people, foreigners strangers etc) from us?" Lot said: "These (the girls of the nation) are my
...
www.islam basics.com`
      ...
      {
        title: "Part 17: From the provided PDF",
        body: `Prophet Shu’aib
Shuaib's Message 
...
them and that what he was doing was not for his personal gain.
 They seized the belongings of Shu'aib and his followers, then drove them out of the city. The`
      ...
      {
        title: "Part 18: From the provided PDF",
        body: `Messenger turned to his Lord for help, and his plea was answered. Allah sent down on them
...
www.islam basics.com`
 ...
 15.`
  ...
  "shuaib": {
    shortIntro: `12. Prophet Yusuf (Joseph)
 13. Prophet Ayoub (Job)
 14 . Prophet Dhul-Kifl 
 ...
 16.`
  ...
  "yusuf": {
    shortIntro: `Introduction to Joseph's Story 
...
to prison, where he remained for some time. In spite of all of this, he at length approached close`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `to the Egyptian throne and became the king's chief minister. He then began his call to Allah from
...
kill him when all you want is to get rid of him. Look here, let us throw him into a well and he will`
      ...
      {
        title: "Part 4: From the provided PDF",
        body: `be picked up by a passing caravan. T hey will take him with them to a distant land. He will
...
of their lies struggling to come out. Jacob wondered aloud: "Why this weeping? Has anything`
      ...
      {
        title: "Part 6: From the provided PDF",
        body: `happened to our flock?" They answered crying: "O our father! We went racing with one another,
...
he peeped into the well. What he saw shocked him; a man was clinging to the rope! He held the`
      ...
      {
        title: "Part 8: From the provided PDF",
        body: `rope tightly and shouted to his friends: "Better give me a hand fellows! Looks like I found real
...
Joseph felt at ease, for at last he was sheltered and would be well cared for. He thanked Allah`
      ...
      {
        title: "Part 10: From the provided PDF",
        body: `over and over and wondered at the mysterious of life. Not so long ago he had been cast into a
...
husband) is my master! He made my stay agreeable! (So I will never betray him). Verily, the`
      ...
      {
        title: "Part 12: From the provided PDF",
        body: `Zalimun (wrong, evildoers) will never be successful." Indeed she did desire him and he would
...
Etiquette dictated that the ladies not mention the topic of Joseph. They were shocked, therefore,`
      ...
      {
        title: "Part 16: From the provided PDF",
        body: `when Zulaikha opened the topic. "I have heard of those who say I have fallen in love with the
...
Hearer, the All Knower.” (Ch 12:31-34)`
      ...
      {
        title: "Part 18: From the provided PDF",
        body: `That evening, Zulaikha convinced her husband that the only way to save her honor was to put
...
Irresistible? You do not worship besides Him but only names which you have named (forged),`
      ...
      {
        title: "Part 19: From the provided PDF",
        body: ``
      },
      {
        title: "Part 20: From the provided PDF",
        body: `you and your fathers, for which Allah has sent down no authority. The command (or the
...
The cupbearer hurried back with the good news. The king was fascinated by Joseph's`
      ...
      {
        title: "Part 21: From the provided PDF",
        body: ``
      },
      {
        title: "Part 22: From the provided PDF",
        body: `interpretation.
...
The eyes of everyone turned to the wife of the chief minister. She now wore a wrinkled face and`
      ...
      {
        title: "Part 23: From the provided PDF",
        body: ``
      },
      {
        title: "Part 24: From the provided PDF",
        body: `had lost weight. She had been overwhelmed by sorrow over Joseph while he was in prison. She
...
merely wanted to rescue hungry nations for a personal gain; he merely wanted to rescue hungry`
      ...
      {
        title: "Part 25: From the provided PDF",
        body: ``
      },
      {
        title: "Part 26: From the provided PDF",
        body: `nations for a period of seven years. It was a sheer nobleness on his part in that he wanted to
...
secretly place the purse, with the money they had paid, into one of their grain sacks.`
      ...
      {
        title: "Part 27: From the provided PDF",
        body: ``
      },
      {
        title: "Part 28: From the provided PDF",
        body: `Joseph Meets His Brothers - Quranic 
...
more food for our family, and we shall guard our brother and add one more measure of a`
      ...
      {
        title: "Part 29: From the provided PDF",
        body: ``
      },
      {
        title: "Part 30: From the provided PDF",
        body: `camel's load. This quantity is easy (for the king to give)."
...
www.islam basics.com`
      ...
      {
        title: "Part 31: From the provided PDF",
        body: ``
      },
      {
        title: "Part 32: From the provided PDF",
        body: `The officers agreed: "We shall apply your law instead of the Egyptian law, which provides for
imprisonment."
...
"And when they entered according to their father's advice, it did not avail them in the least
...
reward of a camel load; I will be bound by it."`
      ...
      {
        title: "Part 33: From the provided PDF",
        body: ``
      },
      {
        title: "Part 34: From the provided PDF",
        body: `They said: "By Allah! Indeed you know that we came not to make mischief in the land, and we
are no thieves!"
...
Allah decides my case (by releasing Benjamin) and He is the Best of the judges." (Ch 12:68-80
Quran).
Joseph's Plan 
...
Allah revealed to us what happened at their meeting with their father:`
      ...
      {
        title: "Part 35: From the provided PDF",
        body: `"Return to your father and say: 'O our father! Verily, your son (Benjamin) has stolen, and we
...
Allah, the Almighty told us:
"They said: "By Allah! You will never cease remembering Joseph until you become weak with old
...
that Allah rewards alms givers. At this moment, in the midst of their plight, Joseph spoke to them`
      ...
      {
        title: "Part 36: From the provided PDF",
        body: `in their native tongue saying: 
...
changed his clothes. The caravan was traveling in the desert with Joseph's shirt hidden among the`
      ...
      {
        title: "Part 37: From the provided PDF",
        body: `grain. It neared the old man's estate. He gesticulated in his room, and then he prayed a long time,
...
"My Lord! You have indeed bestowed on me of the sovereignty, and taught me the interpretation
...
Muslim (the one submitting to Your Will), and join me with the righteous." (Ch 12:101)
...
Before he died, Jacob (pbuh) advised his children to adhere to the teachings of Islam, the religion`
      ...
      {
        title: "Part 38: From the provided PDF",
        body: `of all of Allah's prophets. Allah the Almighty revealed: 
"Or were you witnesses when death approached Jacob? When he said unto his sons: "What will
you worship after me?" they said: "We shall worship your Ilah (God-Allah) the Ilah (God) of
your father. Abraham, Ishmael, Isaac, One Ilah (God), and to Him we submit in Islam." (Ch
12:133 Quran). 
...
www.islam basics.com`
      ...
      {
        title: "Part 39: From the provided PDF",
        body: `Prophet Job (Ayoub)
...
Iblis overhearing all of this, became annoyed. He planned to tempt Job to corruption and disbelief,`
      ...
      {
        title: "Part 40: From the provided PDF",
        body: `so he hastened to him. He tried to distract Job from his prayers by whispering him about the good
...
Iblis Destroys Job's Health`
      ...
      {
        title: "Part 41: From the provided PDF",
        body: ``
      },
      {
        title: "Part 42: From the provided PDF",
        body: `Iblis called on Allah. "O my Lord, Job's wealth is gone, his children are dead, and he is still healthy
...
She replied: "eighty years."`
      ...
      {
        title: "Part 43: From the provided PDF",
        body: ``
      },
      {
        title: "Part 44: From the provided PDF",
        body: `Then Job replied: "How long am I suffering like this?"
...
www.islam basics.com`
      ...
      {
        title: "Part 45: From the provided PDF",
        body: `"While Job was naked, taking a bath, a swarm of gold locusts fell on him, and he started
...
www.islam basics.com`
  ...
  "ayoub": {
    shortIntro: `14 . Prophet Dhul-Kifl 
 15. Prophet Yunus (Jonah)
 ...
 17.`
  ...
  "dhulkifl": {
    shortIntro: `15. Prophet Yunus (Jonah)
 16. Prophet Musa (Moses) & Harun (Aaron)
 17. Prophet Hizqeel (Ez ekiel)
 18.`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Dhul-Kifl 
 15. Prophet Yunus (Jonah)
 16. Prophet Musa (Moses) & Harun (Aaron)
 17. Prophet Hizqeel (Ez ekiel)
 18.`
  ...
  "yunus": {
    shortIntro: `Description of Jonah's People 
...
they believed, We removed from them the torment of disgrace in the life of the present wo`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Yunus (Jonah) 
...
Meanwhile, Jonah had boarded a small ship in the company of other passengers. It sailed all day in`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `calm waters with a good wind blowing at the sails. When night came, the sea suddenly changed. A
...
www.islam basics.com`
      ...
      {
        title: "Part 4: From the provided PDF",
        body: `Jonah continued praying to Allah, repeating this invocation. Fishes, whales, seaweeds, and all the
...
Jonah Ibn Matta.'" (Sahih Bukhari).`
      ...
      {
        title: "Part 6: From the provided PDF",
        body: `Prophet Musa (Moses) and Harun (Aaron)
...
the following policy: males should be slaughtered in one year but spared to live the next year."`
      ...
      {
        title: "Part 8: From the provided PDF",
        body: `Pharaoh found that solution to be safer economically.
...
different from Pharaoh. He was a disbeliever; she was a believer. He was cruel; she was merciful.`
      ...
      {
        title: "Part 10: From the provided PDF",
        body: `He was a tyrant; she was delicate and goodhearted. She was sad because she was infertile and had
...
And We had already forbidden (other) foster suckling mothers for him, until she (his sister came`
      ...
      {
        title: "Part 12: From the provided PDF",
        body: `up and) said: "Shall I direct you to a household who will rear him for you, and sincerely they
...
killed him. He said, "This is of Satan's doing, verily, he is a plain misleading enemy."`
      ...
      {
        title: "Part 14: From the provided PDF",
        body: `He said: "My Lord! Verily, I have wronged myself, so forgive me." Then He forgave him. Verily,
...
Moses was surprised that women were shepherding, as only men were supposed to do it. It is`
      ...
      {
        title: "Part 16: From the provided PDF",
        body: `hard and tiresome work, and one needs to be on the alert. Moses asked: "Why are you
shepherding?"
...
ruffians.`
      ...
      {
        title: "Part 18: From the provided PDF",
        body: `The father asked her how she could be sure of his trustworthiness in such a short time. She
...
Exalted.`
      ...
      {
        title: "Part 20: From the provided PDF",
        body: `Moses Decides to Return to Egypt 
...
transgress all bounds against us."`
      ...
      {
        title: "Part 24: From the provided PDF",
        body: `He (Allah) said: "Fear not, Verily! I am with you both, Hearing and Seeing. So go you both to
...
empire, Pharaoh arranged for a public contest between Moses and the magicians. The people`
      ...
      {
        title: "Part 28: From the provided PDF",
        body: `came in droves as near before when they heard of the greatest contest ever between Pharaoh's
...
They said: "O Moses! Either you throw first or we be the first to throw?"`
      ...
      {
        title: "Part 30: From the provided PDF",
        body: `Moses said: "nay, throw you (first)!" Then behold, their ropes and their sticks, by their magic,
...
Moses and Aaron left, and Pharaoh returned to his palace. Pharaoh entered to his palace. Pharaoh`
      ...
      {
        title: "Part 32: From the provided PDF",
        body: `was completely stupefied when he faced the two miracles. When Moses went out of his presence,
...
Pharaoh asked his director of police: "What about the magicians' corpses?"`
      ...
      {
        title: "Part 34: From the provided PDF",
        body: `He said: "My men hung them in public squares and markets to terrify the people. We will spread a
...
his wicked thoughts.`
      ...
      {
        title: "Part 36: From the provided PDF",
        body: `When Korah did calculate the alms due on his wealth, he was shocked at the large amount he had
...
believer.`
      ...
      {
        title: "Part 38: From the provided PDF",
        body: `This believer spoke in the assembly where the idea of killing Moses had been introduced. He
...
Thus it was made fair seeming, in Pharaoh's eyes, the evil of his deeds, and he was hindered`
      ...
      {
        title: "Part 40: From the provided PDF",
        body: `from the Right Path, and the plot of Pharaoh led to nothing but loss and destruction for him.
...
with you." (Ch 7:134 Quran)`
      ...
      {
        title: "Part 42: From the provided PDF",
        body: `Moses prayed to his Lord and He relived the suffering caused by the flood. The surging water
...
behold! They broke their word! (Ch 7:135 Quran)`
      ...
      {
        title: "Part 44: From the provided PDF",
        body: `Moses' Story - Condensed and Quranic 
...
message. Allah revealed:`
      ...
      {
        title: "Part 46: From the provided PDF",
        body: `"But none believed in Moses except the offspring of his people, because of the fear of Pharaoh
...
so that I may follow those rebels and arrest them!" They rushed across the parted waters, and`
      ...
      {
        title: "Part 47: From the provided PDF",
        body: ``
      },
      {
        title: "Part 48: From the provided PDF",
        body: `when they were midway, Allah commanded the sea to return to its former state.
...
In spite of Pharaoh's death, he left a bad influence on the souls of the children of Israel. It was`
      ...
      {
        title: "Part 49: From the provided PDF",
        body: ``
      },
      {
        title: "Part 50: From the provided PDF",
        body: `difficult for the years of oppression and intense humilty to pass easily. He had made them
...
best.`
      ...
      {
        title: "Part 51: From the provided PDF",
        body: ``
      },
      {
        title: "Part 52: From the provided PDF",
        body: `Allah's Favours on Moses' People - Quranic
Allah the Exalted said: 
...
any other among the Alamin (mankind and jinn), in the past. O my people! Enter the holy land`
      ...
      {
        title: "Part 53: From the provided PDF",
        body: ``
      },
      {
        title: "Part 54: From the provided PDF",
        body: `(Palestine) which Allah has assigned to you and turn not back in flight for then you will be
returned as losers."
...
Allah said: "You cannot see Me, but look upon the mountain if it stands still in its place then you`
      ...
      {
        title: "Part 55: From the provided PDF",
        body: ``
      },
      {
        title: "Part 56: From the provided PDF",
        body: `shall see Me." So when his Lord appeared to the mountain, He made it collapse to dust, and
...
So he collected all their gold jewelry, dug a hole in which he placed the lot, and lit a huge fire to`
      ...
      {
        title: "Part 57: From the provided PDF",
        body: `melt it down. During the casting, he threw a handful of dust, making actions like a magician's to
...
Mount Sinai:`
      ...
      {
        title: "Part 58: From the provided PDF",
        body: `"And what made you hasten from your people, O Moses?"
...
www.islam basics.com`
      ...
      {
        title: "Part 59: From the provided PDF",
        body: ``
      },
      {
        title: "Part 60: From the provided PDF",
        body: `Moses' People Demand to See Allah 
...
they who will be successful. (Ch 7:155-157 Quran)`
      ...
      {
        title: "Part 61: From the provided PDF",
        body: ``
      },
      {
        title: "Part 62: From the provided PDF",
        body: `The Story of Israelites and the Cow - The Pious Man and His Son
...
www.islam basics.com`
      ...
      {
        title: "Part 63: From the provided PDF",
        body: ``
      },
      {
        title: "Part 64: From the provided PDF",
        body: `Moses' People Find the Right Cow
...
moved. Someone in the congregation asked: "O Messenger of Allah, is there another man on`
      ...
      {
        title: "Part 65: From the provided PDF",
        body: ``
      },
      {
        title: "Part 66: From the provided PDF",
        body: `earth more learned than you?" Moses replied: "No!", believing so, as Allah had given him the
...
patience about a thing which you know not?"`
      ...
      {
        title: "Part 67: From the provided PDF",
        body: ``
      },
      {
        title: "Part 68: From the provided PDF",
        body: `Moses said; "If Allah will, you will find me patience, and I will not disobey you in aught."
...
Ibn Nun), till they reached the rock where they laid their heads (lay down). Moses slept, and the`
      ...
      {
        title: "Part 69: From the provided PDF",
        body: ``
      },
      {
        title: "Part 70: From the provided PDF",
        body: `fish, moving out of the basket, fell into the sea. It took its way into the sea straight as in a tunnel.
...
Then both of them went on till they came to some people of a village, and they asked its`
      ...
      {
        title: "Part 71: From the provided PDF",
        body: ``
      },
      {
        title: "Part 72: From the provided PDF",
        body: `inhabitants for food but they refused to entertain them as guests. Then they saw therein a wall
...
stick. By Allah, the stone still has some traces of the hitting, three, four, or five marks. This was`
      ...
      {
        title: "Part 73: From the provided PDF",
        body: `what Allah the Almighty refers to in His saying:
“O you who believe! Be not like those who annoyed Moses, but Allah cleared him of that which
...
www.islam basics.com`
      ...
      {
        title: "Part 74: From the provided PDF",
        body: `Prophet Hizqeel (Ezekiel)
...
not go out fleeing it, and if you hear it is in a country, do not enter it." Umar praised Allah and`
      ...
      {
        title: "Part 75: From the provided PDF",
        body: `then went off.
...
of Ba'alabak, and when Elijah died, he Elisha succeeded him as a prophet among his people.`
  ...
  "musa": {
    shortIntro: `17. Prophet Hizqeel (Ez ekiel)
 18. Prophet Elyas (Elisha)
 19.`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Musa (Moses) & Harun (Aaron)
 17. Prophet Hizqeel (Ez ekiel)
 18. Prophet Elyas (Elisha)
 19.`
      }
  ...
  "hizqeel": {
    shortIntro: `18. Prophet Elyas (Elisha)
 ...
 21.`
  ...
  "ilyas": {
    shortIntro: `19. Prophet Shammil (Samuel)
 20. Prophet Dawud (David)
 ...
 22.`
  ...
  "shammil": {
    shortIntro: `The State of the Israelites After Joshua 
...
They used to go war, taking with them The Ark of the Covenant. They did`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Shammil (Samuel) 
...
And their Prophet (Samuel) said to them:`
      ...
      {
        title: "Part 5: From the provided PDF",
        body: `"Have you not thought about the group of the Children of Israel after (the time of) MusÂ
...
from responsibilities should join. Those engaged in building homes, men who were about to be`
      ...
      {
        title: "Part 6: From the provided PDF",
        body: `married and those occupied with business should not join.
...
small force to defeat a larger one.`
  ...
  "dawud": {
    shortIntro: `David Challenges Goliath 
...
the hand of his pretty daughter in marriage to the man who would fight Goliath, but even t`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Dawud (David)
...
Allah, the Lord of the Israelites, Whose laws you have mocked. Today you will see that it is not`
      ...
      {
        title: "Part 3: From the provided PDF",
        body: `the sword that kills but the will and power of Allah!"
...
38:17 Quran).`
      ...
      {
        title: "Part 5: From the provided PDF",
        body: `David's sincerity was not the only factor responsible for the birds and beasts joining with him in
...
thick of battle, Saul's henchmen might stab him in the back. Yet he hastened with his troops to`
      ...
      {
        title: "Part 7: From the provided PDF",
        body: `meet the army of Canaan. They fought the Canaanites brav, without thinking of their own safety.
...
you give him your sheep in exchange for the field." Solomon, to whom Allah had given wisdom in`
      ...
      {
        title: "Part 9: From the provided PDF",
        body: `addition to what he had inherited from his father, spoke up: "I have another opinion. The owner
...
"Verily, this is my brother (in religion) has ninety nine ewes, while I have only one ewe, and he`
      ...
      {
        title: "Part 10: From the provided PDF",
        body: `says: 'Hand it over to me,' and he overpowered me in speech."
...
clever method of channeling water all over their cities. He was keen to build similar water systems`
      ...
      {
        title: "Part 14: From the provided PDF",
        body: `in his own country but did not have enough springs.
...
soldiers, which included lions, tigers, and birds. The messengers stood in amazement, realizing`
      ...
      {
        title: "Part 16: From the provided PDF",
        body: `that they were in front of an irresistible army.
...
which her people worshipped was nothing but one of Allah's creatures.`
      ...
      {
        title: "Part 18: From the provided PDF",
        body: `The sun eclipsed within her for the first time, and her heart was lit by a never fading light, the light
of Islam. 
...
One with whom was knowledge of the Scripture said: "I will bring it to you within the twinkling`
      ...
      {
        title: "Part 20: From the provided PDF",
        body: `of an eye!" then when Solomon saw it placed before him, he said: "This is by the Grace of my
...
Allah the Exalted revealed:`
      ...
      {
        title: "Part 21: From the provided PDF",
        body: `"And We caused a fount of molten brass to flow for him, and there were jinns that worked in
...
www.islam basics.com`
  ...
  "sulaiman": {
    shortIntro: `22. Prophet Shia (Isaiah)
 ...
 25.`
  ...
  "shia": {
    shortIntro: `Isaiah and Hezekiah 
...
obedient to Isaiah in wh`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Shia (Isaiah)
 Isaiah and Hezekiah 
Among the prophets between David and Zakariah is Isaiah (pbuh), Ibn Amoz (Amisiah).
According to Muhammad Ibn Ishaaq, Isaiah (pbuh) appeared before Zakariah (pbuh) and Yahya
(John the Baptist) (pbuh). He is among those who prophesied about Isa (Jesus) (pbuh) and
...
Israel immediately sent for them, put them in shackles and displayed them in the land for seventy`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `days to spite and insult them. Every day each of them was fed a loaf of barley bread; after seventy
...
www.islam basics.com`
  ...
  "aramaya": {
    shortIntro: `Jeremiah's Family History 
...
Ibn Zechariah while it was flowing and he said: \"O blo`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Aramaya (Jeremiah)
...
disbeliveers." (Ch 17:2-8 Quran).`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `Allah's Message to the Children of Israel 
...
teach and learn what they like. As for the children of the prophets, they are oppressed and`
      ...
      {
        title: "Part 4: From the provided PDF",
        body: `seduced and go with the crowd. They want the positions of their fathers without the discipline,
...
imprisoned him. At this, Allah sent Nabuchadnezzar upon them. He entered the country with his`
      ...
      {
        title: "Part 6: From the provided PDF",
        body: `troops and surrounded the city. When the siege was prolonged they surrendered to his rule. They
...
Ibn Al-Kalbi said that the Israelites settled it, and Allah rebuilt their glory. It remained so until`
      ...
      {
        title: "Part 9: From the provided PDF",
        body: `Rome vanquished them in the era of the tribal kings; then they lost their community and their
...
www.islam basics.com`
  ...
  "daniel": {
    shortIntro: `Allah Saves Daniel from the Lions 
...
Allah revealed to Jeremiah, who was in Sham (Palestine/Syria): \"Prepare food`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Daniel 
...
as four hundred, six hundred, and six hundred twenty years. It could be that he had died eight`
      ...
      {
        title: "Part 3: From the provided PDF",
        body: `hundred years earlier, which would be near to Daniel's time, if his being Daniel is correct.
...
has a good citation.`
  ...
  "uzair": {
    shortIntro: `Ezra Sleeps For 100 Years 
...
taking figs and grapes in his basket. He went under the shade of the khaiba tree and ate `,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Uzair (Ezra)
...
said: "I bear witness that you are Ezra."`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `Ezra Finds and Copies the Torah 
...
www.islam basics.com`
  ...
  "zakariyya": {
    shortIntro: `Description of Zakariyah 
...
disappointment in life was that he had no children, for his wife was barren. This worried him, for`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Zakariyah (Zechariah) 
...
He said: "So (it will be). Your Lord says, It is easy for Me. Certainly I have created you before,`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `when you had been nothing."
...
or leaves of trees. John loved reading since childhood. When he grew up, Allah the Exalt`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Yahya (John) 
John's Childhood 
John (pbuh) was born a stranger to the world of children who used to amuse themselves, as he
was serious all the time. Most children took delight in torturing animals whereas, he was merciful
to them. He fed the animals from his food until there was nothing left for him, and he just ate fruit
...
Mary's Family History`
      ...
      {
        title: "Part 4: From the provided PDF",
        body: `Allah declared that He had elected Adam (pbuh) and the elite of his offspring who obey Allah.
...
Mary's High Status -`
  ...
  "isa": {
    shortIntro: `29. Prophet Muhammad`,
    sections: [
      {
        title: "Part 1: From the provided PDF",
        body: `Prophet Isa (Jesus)
 29. Prophet Muhammad
...
You with praises and thanks (exalted be Y ou above all that they associate with
You as partners) and sanctify You.' Allah said: 'I know that which you do  not
know.'
Allah taught Adam al l the names of everything, then He showed them to the
...
them of their names, He said: "Did I not tell you that I know the u nseen in the
...
prostrated except I blis, he refused and was proud and was one of the
disbelievers(disobedient to Allah)."
We said: "O Adam! Dwell you and your wife in the Paradise and both of you
freely with pl easure and delight of things therein as wherever you will but come
...
time."`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `Then Adam r eceived from his Lord Words. His Lord pardoned him (accepted his
...
shall be no fear on them, nor shall they grieve. But t hose who disbelieve and
...
commanded you?" 
Iblis said: "I am better than him (Adam), You created me fr om fire and him You
created from clay."
...
Iblis said: "Allow me r espite till the Day th ey are raised up (Day of
Resurrection)."
Allah said: "You are of those allowed respite."
Iblis said: "Because You have sent me astray, surely I will sit in wait against
them (human beings) on Your Straight Path. Then I will come to t hem from
before them an d behind them, from their right and from their left and You will
...
(unjust and wrongdoers)."`
      ...
      {
        title: "Part 3: From the provided PDF",
        body: `“Then Satan whispered suggestions to them both in order to uncover that which
...
They said: "Our Lord! We have wr onged ourselves. If You forgive us not, and
bestow not upon us Your Mercy, we shall certainly be of the losers." Allah said:
"Get down one of  you an enemy to t he other (i.e. Adam, Eve, and Satan etc). On
earth will be a dwell ing place for you and an enjoyment , for a time." He said:
...
them." (Sahih al Bukhari).`
      ...
      {
        title: "Part 5: From the provided PDF",
        body: `Ibn Masud and other companions of the Prophet (PBUH) said that Allah the Almighty sent
...
al Bukhari).`
      ...
      {
        title: "Part 7: From the provided PDF",
        body: `Adam's Progeny Accept Allah 
Allah the Almighty revealed: 
...
Similarity between Adam and Jesus (PBUT)
 Allah the Almighty declared:`
      ...
      {
        title: "Part 9: From the provided PDF",
        body: `"Verily the likeness of Jesus, in Allah's Sight is the likeness of Adam, He created him from the
...
Iblis tried in vain to justify his refusal:`
      ...
      {
        title: "Part 11: From the provided PDF",
        body: `"Shall I prostrate to one whom You created from clay?" Iblis said: "See? those whom You have
...
(mankind) that follow you together." (Ch 38:71-85 Quran).`
      ...
      {
        title: "Part 13: From the provided PDF",
        body: `The Reason for Adam's Creation
...
was a paradise on the earth located in a high place. Another group of commentators accept what`
      ...
      {
        title: "Part 17: From the provided PDF",
        body: `was in the Quran without questioning where this paradise was located. We agree with this last
...
Verily, We made the devils (protectors and helpers) for those who believe not." (Ch 7:27)`
      ...
      {
        title: "Part 19: From the provided PDF",
        body: `Adam had hardly finished eating when he felt his heart contract, and he as filled with pain,
...
follows My Guidance shall neither go astray, nor fall into distress and misery. But whosoever`
      ...
      {
        title: "Part 21: From the provided PDF",
        body: `turns away from My Reminder (neither believes in this Quran nor acts on its orders etc). Verily,
...
other. Moses said to Adam: 'Your sin expelled you from Paradise.' Adam said: ' You are Moses`
      ...
      {
        title: "Part 23: From the provided PDF",
        body: `whom Allah selected as His messenger and as the one to whom He spoke directly. Yet you blame
...
along with him.`
      ...
      {
        title: "Part 25: From the provided PDF",
        body: `Adam grasped all of this and with the knowledge of this suffering he started his life on the earth.
...
unhappy!"`
      ...
      {
        title: "Part 27: From the provided PDF",
        body: `Abel feeling sorry for his brother, replied, "It would be more proper for you, my brother to search
...
So the self of the other (latter one) encouraged him and made fair seeming to him the murder of`
      ...
      {
        title: "Part 29: From the provided PDF",
        body: `his brother; he murdered him and became one of the losers. Allah sent a crow who scratched the
...
them to his son Khonoukh, who is Idris (pbuh) according to the majority of the scholars.`
  ...
  "muhammad": {
    shortIntro: `Description of Muhammad 
...
www.islam basics.com`
      ...
      {
        title: "Part 2: From the provided PDF",
        body: `Muhammad's marriage to Khadijah 
...
helpful to the needy and the helpless. His uncle Abu Talib had fallen into distress through his`
      ...
      {
        title: "Part 4: From the provided PDF",
        body: `endeavors to maintain the old position of his family. Muhammad, being rather rich at this time by
...
Makkans, at that time, relied heavily on trade that revolved around polytheistic and pagan rituals`
      ...
      {
        title: "Part 8: From the provided PDF",
        body: `of false idols and statues and other things that they worshipped. One can't contemplate his future
...
worship of idols. Polytheism was deeply rooted among the people. It offered attractions, which`
      ...
      {
        title: "Part 10: From the provided PDF",
        body: `the new faith in its purity did not possess. The Quraish had personal material interests in the old
...
"Nay, they wonder that there has come to them a Warner (Muhammad) from among themselves.`
      ...
      {
        title: "Part 12: From the provided PDF",
        body: `So the disbeliveers say: "This is a strange thing! When we are dead and have become dust (shall
...
tribes, that you may know one another. Verily, the most honorable of you in the Sight of Allah is`
      ...
      {
        title: "Part 14: From the provided PDF",
        body: `that believer who has At Taqwa (one of the Muttaqun, pious and righteous persons who fear
...
(God) is One Ilah (God - Allah), therefore take the Straight Path to Him (with true Faith -`
      ...
      {
        title: "Part 16: From the provided PDF",
        body: `Islamic Monotheism) and obedience to Him, and seek forgiveness of Him. And woe to
...
of idols and enjoined us to speak the truth, to be faithful to our trusts, to be merciful, and to`
      ...
      {
        title: "Part 18: From the provided PDF",
        body: `regard the rights of neighbors; he forbade us to speak evil of the worship of Allah and not to
...
the Prophet used to assert to the disbeliveers, is a book of blessings which is a warning for the`
      ...
      {
        title: "Part 20: From the provided PDF",
        body: `whole world; it is a complete guidance and explains everything necessary; it is a reminder of what
...
being kinsmen of the Prophet, to protect their member from falling a victim to the hatred of rival`
      ...
      {
        title: "Part 22: From the provided PDF",
        body: `parties. All the members of the two families nobly responded to the appeal of Abu Talib except
...
In the following year, both Abu Talib and Khadijah died. Thus the Prophet lost in Abu Talib the`
      ...
      {
        title: "Part 24: From the provided PDF",
        body: `kind guardian of his youth who had hitherto protected him against his enemies, and in Khadijah
...
The Prophet said: "The animal's step (was so wide that it) reached the farthest point within the`
      ...
      {
        title: "Part 26: From the provided PDF",
        body: `reach of the animals' sight. I was carried on it.
...
Then Gabriel ascended with me to the fifth heaven and asked for its gate to be opened. It was`
      ...
      {
        title: "Part 28: From the provided PDF",
        body: `asked: 'Who is it?' Gabriel replied: 'Gabriel.' It was asked: 'Who is accompany you?' Gabriel
replied 'Muhammad.' It was asked: 'Has he been called?' Gabriel replied in the affirmative. Then it
...
Lord and ask for reduction to lessen your followers'' burden.' So I went back, and Allah reduced`
      ...
      {
        title: "Part 30: From the provided PDF",
        body: `ten prayers for me. Then again I came to Moses, but he repeated the same as he had said before.
...
faithful to them, on condition that they should worship none but Allah observe the precepts of`
      ...
      {
        title: "Part 32: From the provided PDF",
        body: `Islam, obey the Prophet in all that was right, and protect him against all insults as heartily as they
...
relations with your kith and kin, help the weak and the poor, entertain guests generously, and help`
      ...
      {
        title: "Part 34: From the provided PDF",
        body: `the calamity-stricken persons. Therefore, I am your protector. Go back and worship your Lord in
your town.'
...
before.' Abu Bakr said: 'May my parents be sacrificed for him. By Allah he has not come at this`
      ...
      {
        title: "Part 36: From the provided PDF",
        body: `hour except for a great necessity.' So Allah's Messenger came and asked permission to enter, and
...
it gallop, giving no importance to the divining arrows. When I heard the recitation of the Qur'an`
      ...
      {
        title: "Part 38: From the provided PDF",
        body: `by Allah's Messenger who did not look hither and thither while Abu Bakr was doing it often,
...
rewardable.' He was also saying: 'O Allah! The actual reward is the reward in the Hereafter, so`
      ...
      {
        title: "Part 40: From the provided PDF",
        body: `bestow Your Mercy on the Ansar and the Emigrants.' Thus the Prophet recited (by way of
...
our assistance and good offices. The Jews of the various branches and all others doiciled in`
      ...
      {
        title: "Part 42: From the provided PDF",
        body: `Medina shall form with the Muslims one composite nation; they shall practice their religion as
...
from within or a sudden attack from without.`
      ...
      {
        title: "Part 44: From the provided PDF",
        body: `Battle of Badr - Makkan Troop formations approaching Madina 
...
their side against their enemies. The division of the spoils created some dissension between the`
      ...
      {
        title: "Part 46: From the provided PDF",
        body: `Muslim warriors. For the moment, the Prophet divided it equally among all. Subsequently, a
...
think that you will enter Paradise before Allah tests those of you who fought (in His Cause) and`
      ...
      {
        title: "Part 48: From the provided PDF",
        body: `(also) tests those who are patient? You did indeed wish for death (Ash-shahadah- martyrdom)
...
companions and said: 'As for these (men), they have been killed.' 'Umar could not control himself`
      ...
      {
        title: "Part 50: From the provided PDF",
        body: `and said to Abu Sufyan: ' You told a lie, by Allah! O enemy of Allah! All those you have
...
up in their fortress and set the Prophet and his authority at defiance. The Muslims decided to`
      ...
      {
        title: "Part 52: From the provided PDF",
        body: `reduce them and laid siege to their fortress without loss of time. After fifteen days they
...
compact to assist the Muslim s against any raiders. These Jews, however, were induced by the`
      ...
      {
        title: "Part 54: From the provided PDF",
        body: `idolaters to violate their pledge and to join the Quraish. As these Jews were acquainted with the
...
for the journey to Mecca. The Prophet, accompanied by seven or eight hundred Muslims,`
      ...
      {
        title: "Part 56: From the provided PDF",
        body: `Emigrants and Ansars, all totally unarmed, set out on the pilgrimage. The Quraish, who were still
...
would have not have spoken the truth about the Prophet." Abu Sufyan's narration continues:`
      ...
      {
        title: "Part 57: From the provided PDF",
        body: `"The first question he asked me about him was;
...
Heraclius said: "What does he order you to do?"`
      ...
      {
        title: "Part 58: From the provided PDF",
        body: `I said: "He tells us to worship Allah and Allah alone and not to worship anything along with Him,
...
King of Bani Al-Asfar (Byzantine) was afraid of him. Then I started to become sure that he (the`
      ...
      {
        title: "Part 60: From the provided PDF",
        body: `Prophet) would be the conqueror in the near future till I embraced Islam (Allah guided me to it).
...
religion. After subduing Khaibar, the Muslims returned to Medina in safety.`
      ...
      {
        title: "Part 62: From the provided PDF",
        body: `Allah's Messenger and the Muslims perfom Hajj
...
violated the terms of the peace concluded at Hudaibiya by attacking the Bani Khuzaah, who were`
      ...
      {
        title: "Part 64: From the provided PDF",
        body: `in alliance with the Muslims. The Bani Khuzzah appealed to the Prophet for help and protection.
...
All-Knowing, All-Aware. (Ch 49:13 Quran)`
      ...
      {
        title: "Part 66: From the provided PDF",
        body: `Narrated Hisham's father: When Allah's Messenger set out (towards Mecca) during the year of the
...
Narrated Urwa: Nafi' Ibn Jubair Ibn Mut'im said: "I heard Al-Abbas saying to Az-Zubair Ibn Al-
Awwam, 'O Abu Abdullah! Did Allah's Messenger order you to fix the flag here?' "Allah's
...
orphans of the slain and severely rebuked Khalid.`
      ...
      {
        title: "Part 68: From the provided PDF",
        body: `At this time the tribes of Hawazin and Thakif showed unwillingness to render obedience to the
...
detachment under Ali was sent to reduce them to obedience and to destroy their idols. The prince`
      ...
      {
        title: "Part 70: From the provided PDF",
        body: `of the tribe was 'Adi, the son of the famous Hatim, whose generosity was spoken of all over
...
charity, goodness, justice, and universal love. They could now perceive that Allah was not that`
      ...
      {
        title: "Part 72: From the provided PDF",
        body: `which they had carved out of wood or stone, but the Almighty Loving, Merciful, the Creator of
the Universe.
...
come to you for justice unless you first hear both of them."`
      ...
      {
        title: "Part 74: From the provided PDF",
        body: `Murders and false claims of Prophethood arise
...
Allah in His Book has prohibited."`
      ...
      {
        title: "Part 75: From the provided PDF",
        body: `Then turning to the women who sat close by, he exclaimed: "O Fatimah, my, daughter, and Safia,
